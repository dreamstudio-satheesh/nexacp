...
VERSION=$(curl -s https://resource.nexacp.in/v2/${INSTALL_MODE}/latest)
HASH_FILE_URL="https://resource.nexacp.in/v2/${INSTALL_MODE}/${VERSION}/release/checksums.txt"
...
PACKAGE_DOWNLOAD_URL="https://resource.nexacp.in/v2/${INSTALL_MODE}/${VERSION}/release/${PACKAGE_FILE_NAME}"
...
echo "Preparing to download NexaCP ${VERSION} (${architecture}, mode: ${INSTALL_MODE})."
