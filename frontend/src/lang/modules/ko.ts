...
const message = {
    commons: {
        ...
        rule: {
            ...
            nginxDoc: '이 필드는 영어, 숫자, ".", "_", "-" 문자로 구성되어야 합니다.',
            appName:
            ...
            vmName: '영문, 숫자, ".", "-", "_"를 지원하며 길이는 1-64자이고 영문 또는 숫자로 시작해야 합니다.',
            vmNetwork: '영문, 숫자, ".", ":", "-", "_"를 지원하며 길이는 1-64자이고 영문 또는 숫자로 시작해야 합니다.',
    ...
    home: {
        ...
        loadAverage: '지난 1분의 평균 부하 | 지난 {0}분의 평균 부하',
        load: '부하',
        mount: '마운트 지점',
        fileSystem: '파일 시스템',
        total: '전체',
    ...
    database: {
        ...
        deleteUserHelper: '"를 입력하여 이 사용자를 삭제하세요.',
    ...
    aiTools: {
        agents: {
            ...
            roleMarkdownDescriptions: {
                ...
                'SOUL.md': ['페르소나, 말투, 경계.'],
                'USER.md': ['사용자가 누구인지, 어떻게 호칭할지.'],
                'IDENTITY.md': ['에이전트의 이름, 분위기, 이모지.'],
                'TOOLS.md': ['로컬 도구와 사용 규약에 대한 메모입니다.'],
        ...
        aiProxy: {
            ...
            keepCurrentValidity: '현재 유효 기간 유지',
            neverExpires: '만료 없음',
            validForDays: '{0}일 동안 유효',
            customDays: '사용자 지정 일수',
            enterValidityDays: '유효 일수를 입력하세요',
            currentExpiresAt: '현재 만료 시간: {0}',
            currentNeverExpires: '현재 만료되지 않음',
            expiresAt: '만료 시간',
            expired: '만료됨',
            reactivate: '다시 활성화',
            ...
            currentLimit: '현재 / 한도',
            utilization: '사용률',
            autoRefreshSeconds: '{0}초마다 자동 새로고침',
            zeroMeansUnlimited: '0으로 설정하면 제한이 없습니다.',
            groupMaxConcurrencyDesc: '그룹의 모든 API Key 활성 요청 수를 제한합니다. 0은 무제한입니다.',
            apiKeyMaxConcurrencyDesc: '그룹 내 각 API Key의 활성 요청 수를 제한합니다. 0은 무제한입니다.',
            schedulingReason: '스케줄링 이유',
            schedulingAffinity: '선호 계정',
            schedulingLeastUtilized: '최저 사용률',
            schedulingPriorityFallback: '우선순위 폴백',
            schedulingRetry: '재시도',
            queueSize: '대기열 크기',
            ...
            severityLow: '낮음',
            sensitiveWord: '민감 단어',
            sensitiveGroup: '민감 단어 그룹',
            sensitiveWordCount: '단어 수',
            normalizedWord: '정규화된 단어',
            matchedWords: '일치한 단어',
            matchedGroups: '일치한 그룹',
        ...
        mcp: {
            server: 'MCP 서버',
            baseUrl: '외부 접근 경로',
            baseUrlHelper: '예: http://192.168.1.2:8000',
            ssePath: 'SSE 경로',
            ssePathHelper: '예: /sse, 다른 서버와 중복되지 않도록 주의하세요',
            environment: '환경 변수',
            envKey: '변수 이름',
            envValue: '변수 값',
            externalUrl: '외부 연결 주소',
            operatorHelper: '{0}에 {1} 작업을 수행합니다. 계속하시겠습니까?',
            domain: '기본 접근 주소',
            domainHelper: '예: 192.168.1.1 또는 example.com',
            bindDomain: '웹사이트 바인딩',
            commandPlaceHolder: '현재 npx 및 바이너리 시작 명령만 지원합니다',
            importMcpJson: 'MCP 서버 구성 가져오기',
            importMcpJsonError: 'mcpServers 구조가 올바르지 않습니다',
            bindDomainHelper:
    ...
    container: {
        ...
        downLogHelper2: '컨테이너 {0}의 최신 로그 {1}줄을 다운로드합니다. 계속하시겠습니까?',
        ...
        mirrors: '레지스트리 미러들',
        mirrorsHelper:
            '이미지 작업에 레지스트리 미러 URL을 우선 사용합니다. 레지스트리 미러를 비활성화하려면 비워 두세요.',
    ...
    setting: {
        ...
        code: '인증 코드',
        codeHelper:
            '"획득" 버튼을 클릭한 다음 {0}에 로그인하여 리디렉션된 링크에서 "code" 이후의 내용을 복사하십시오. 이 입력 상자에 붙여넣으십시오. 자세한 지침은 공식 문서를 참조하십시오.',
        googleHelper:
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreSSLExpired: '{0} 인증서가 만료되었습니다',
                scoreSSLHigh: '{0} 인증서 만료까지 {1}일 남음',
                scoreSSLMedium: '{0} 인증서 만료까지 {1}일 남음',
                scoreWebsiteExpired: '{0} 웹사이트가 만료되었습니다',
                ...
                serviceEnabledButAbnormal: '활성화되었지만 비정상 상태입니다',
                ...
                disabledCronjobTasks: '비활성화된 예약 작업',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: '연결 모드',
                    accessModeDesc: 'ID 공급자가 지원할 때마다 표준 Discovery를 사용하세요.',
                    actionCreate: '사용자 만들기',
                    actionKeepName: '현재 이름 유지',
                    actionPending: '결과를 기다리는 중',
                    actionReject: '로그인 거부',
                    actionUpdate: '신원 정보 업데이트',
                    advanced: '고급 설정',
                    advancedDesc: '공급자가 호환성 옵션을 요구하지 않는 한 안전한 기본값을 유지하세요.',
                    assignDefaultRole: '기본 역할 할당: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: '유효한 Authorization Endpoint를 입력하세요.',
                    authorizationFlow: '인가 흐름',
                    automatic: '자동',
                    automaticPolicy: '자동 처리 정책',
                    automaticPolicyDesc: '이 규칙은 백엔드에 의해 시행되며 관리자 스위치가 아닙니다.',
                    basic: '기본 설정',
                    basicDesc: '공급자 모드를 선택한 다음 클라이언트와 콜백을 구성합니다.',
                    browserTest: '브라우저 테스트 로그인',
                    browserTestConflict: '신원은 확인되었지만 사용자 이름이 충돌합니다',
                    browserTestConflictHelper: '매핑된 사용자 이름은 다른 신원에 속하므로 자동으로 연결하지 않습니다.',
                    browserTestExpired: '브라우저 테스트가 만료되었습니다.',
                    browserTestExpiredHelper: '만료되기 전에 새 브라우저 테스트를 시작하고 인증을 완료하세요.',
                    browserTestFailed: '브라우저 테스트 실패',
                    browserTestFailedHelper: '신원 미리보기를 완료할 수 없습니다. 현지화된 백엔드 오류를 검토하세요.',
                    browserTestIsolation:
                        '실제 인증 왕복을 수행하지만 사용자를 생성하거나 업데이트하지 않고, 역할을 할당하거나 인증된 패널 세션을 생성하지 않습니다.',
                    browserTestPopupBlocked: '이 사이트에 대한 팝업을 허용한 다음 브라우저 테스트를 다시 시작하세요.',
                    browserTestPopupClosed: '테스트가 완료되기 전에 인증 창이 닫혔습니다.',
                    browserTestSuccess: '공급자 확인 성공',
                    browserTestSuccessHelper: '사용자 또는 세션을 변경하지 않고 ID 매핑을 미리 보았습니다.',
                    browserTestTitle: 'OIDC 브라우저 테스트 로그인',
                    browserTestWaiting: '공급자 인증 대기 중',
                    browserTestWaitingHelper:
                        '새 브라우저 창에서 로그인을 완료하세요. 이 페이지는 자동으로 업데이트됩니다.',
                    callbackCopied: 'OIDC 콜백 URL이 복사되었습니다.',
                    callbackURL: '콜백 URL',
                    callbackURLHelper: '이 URL을 ID 공급자 클라이언트의 허용된 콜백 URL에 추가하세요.',
                    cancelClearSecret: '삭제 취소',
                    clearSecret: 'Client Secret 지우기',
                    clearSecretConfirm: 'Client Secret은 저장한 후에만 제거됩니다. 계속하시겠습니까?',
                    clientAuthMethod: '클라이언트 인증 방법',
                    clientAuthMethodHelper: 'ID 공급자에서 이 클라이언트에 설정한 인증 방식을 선택하세요.',
                    clientAuthMethodRequired: '클라이언트 인증 방법을 선택하세요.',
                    clientID: 'Client ID',
                    clientIDRequired: 'Client ID를 입력하세요.',
                    ...
                    compatibilityModeHelper:
                        '불완전한 Discovery 또는 다시 작성된 엔드포인트에만 사용하세요. 코어 OIDC 검증은 활성화된 상태로 유지됩니다.',
                    configurationFailedHelper: '테스트에 실패했습니다. 페이지에 현지화된 백엔드 오류만 표시됩니다.',
                    configurationFailedTag: '테스트 실패',
                    configurationHighRiskPassed: '구성이 통과되었지만 고위험 호환성 옵션이 포함되어 있습니다.',
                    configurationHighRiskTag: '고위험 구성이 통과되었습니다.',
                    configurationNotTested: '현재 구성은 테스트되지 않았습니다.',
                    configurationNotTestedTag: '테스트되지 않음',
                    configurationPassed: '현재 구성이 보안 및 기능 검사를 통과했습니다.',
                    configurationPassedTag: '테스트 통과',
                    configurationStaleHelper: '구성이 변경되었습니다. 저장하기 전에 다시 테스트하세요.',
                    configurationStaleTag: '결과가 만료되었습니다.',
                    configurationTestMeta:
                        '{time}에 테스트했으며 {duration}ms 만에 완료했습니다. 공급자의 원시 응답은 저장하지 않습니다.',
                    configurationTestResult: '구성 테스트 결과',
                    configurationTestResultDesc:
                        '이것은 Discovery 및 기능만 확인합니다. 인증 코드를 교환하거나 Client Secret를 증명하지 않습니다. 엔드투엔드 확인을 위해 브라우저 테스트 로그인을 사용하세요.',
                    configurationTestSuccess: 'OIDC 구성 테스트에 성공했습니다.',
                    configurationTesting: '현재 OIDC 구성 테스트 중...',
                    configurationTestingTag: '테스트 중',
                    configureSecret: 'Client Secret 설정',
                    conflictExistingRename: '바인딩된 subject가 이미 사용 중인 새 사용자 이름을 반환합니다',
                    conflictExistingRenameResult: '기존 User.Name를 유지하고 바인딩된 사용자가 로그인하도록 허용',
                    conflictLDAP: 'LDAP 사용자',
                    conflictLocal: '로컬 사용자',
                    conflictNewAvailable: '새 subject와 매핑된 사용자 이름을 사용할 수 있습니다',
                    conflictNewAvailableResult: '엔터프라이즈 사용자를 생성하고 기본 역할 할당',
                    conflictNone: '충돌 없음',
                    conflictOIDC: '다른 OIDC ID',
                    conflictOccupied: '매핑된 사용자 이름은 로컬 사용자, LDAP 사용자 또는 다른 OIDC 신원에 속합니다.',
                    conflictOccupiedResult: '새 ID를 거부합니다. 자동으로 바인딩하거나 병합하지 않음',
                    conflictType: '충돌 유형',
                    connectionSecurity: '연결 보안',
                    connectionSecurityDesc: 'TLS 정책은 Discovery, Token, JWKS 및 UserInfo 요청에 적용됩니다.',
                    connectionTest: '연결 및 구성 테스트',
                    connectionTestCompatibilityDesc: '사용자 지정 엔드포인트 및 프로토콜 보안 정책을 검증합니다.',
                    connectionTestStandardDesc: '엔드포인트와 기능은 Issuer에서 자동으로 검색됩니다.',
                    connectionTestTab: '연결 테스트',
                    customCA: '사용자 지정 CA',
                    customCAHelper: '이 인증 소스에만 적용되고 로그에는 기록되지 않습니다.',
                    customCARequired: '사용자 지정 CA 인증서를 입력하세요.',
                    defaultRole: '기본 역할',
                    defaultRoleHelper:
                        '사용자를 처음 생성할 때만 할당하며, 이후 로그인에서는 역할을 변경하지 않습니다.',
                    defaultRolePlaceholder: '역할 선택',
                    defaultRoleRequired: '유효한 기본 역할을 선택하세요.',
                    disableAfterSave: 'OIDC는 저장 후 비활성화됩니다.',
                    disableConfirm:
                        'OIDC를 비활성화하면 이 인증 소스 사용자의 접근 권한이 즉시 무효화됩니다. 계속하시겠습니까?',
                    disableDiscardConfirm:
                        'OIDC를 비활성화하는 것은 긴급 조치입니다. 로그인 항목만 닫히고 이 소스 사용자의 액세스가 즉시 무효화됩니다. Client Secret 변경사항을 포함하여 이 페이지에서 저장되지 않은 다른 변경사항은 삭제됩니다. 계속하시겠습니까?',
                    disableTitle: 'OIDC 비활성화',
                    disabled: '비활성화됨',
                    discoveryAllowlist: 'Discovery 보안 허용 목록',
                    enable: '활성화',
                    enableAfterSave: 'OIDC는 성공적으로 저장되면 활성화됩니다.',
                    enabled: '활성화됨',
                    endSessionEndpoint: 'End Session Endpoint',
                    endSessionEndpointHelper:
                        '향후 사용을 위해 저장합니다. 공급자 시작 로그아웃은 이번 버전에 포함되지 않습니다.',
                    endSessionEndpointInvalid: '유효한 End Session Endpoint를 입력하세요.',
                    endpointDiscoveryPlaceholder: '연결 테스트 후 표시됩니다',
                    firstLogin: '첫 번째 로그인',
                    firstLoginPolicy: '로컬 기업 사용자를 생성하고 구성된 기본 역할을 할당하세요.',
                    fixedAuthorizationCode: 'Authorization Code Flow',
                    fixedNoTokenPersistence: 'Token, Claims 및 verifier를 저장하지 않음',
                    fixedSecurityPolicy: '항상 시행됩니다. 구성 필요 없음',
                    fixedStateNonce: '일회성 state 및 nonce',
                    fixedTokenValidation: 'ID Token 서명 및 Claims 검증',
                    highRiskSaveConfirm:
                        '이 활성화된 구성에는 고위험 호환성 옵션이 포함되어 있습니다. 격리된 환경에 필요한지 확인하세요.',
                    highRiskTitle: '고위험 OIDC 구성',
                    hs256Compatibility: 'HS256(호환성)',
                    hs256KeyHelper:
                        'HS256은 항상 이 인증 소스의 Client Secret을 사용하며 별도의 서명 키를 허용하지 않습니다.',
                    hs256Warning:
                        'HS256은 ID Token 서명에 공유 대칭 비밀을 사용합니다. 공급자가 비대칭 알고리즘을 사용할 수 없는 경우에만 사용하세요.',
                    identityBindingPolicy:
                        '신원은 AuthSourceID + issuer + subject로 고정됩니다. 사용자 이름이 같더라도 다른 계정을 자동으로 연결하지 않습니다.',
                    identityMissing: 'ID 비활성',
                    issuer: 'Issuer URL',
                    issuerHelper: 'ID Token iss 값과 Discovery issuer는 이 값과 정확히 일치해야 합니다.',
                    issuerInvalid: '쿼리나 프래그먼트가 없는 유효한 HTTP 또는 HTTPS Issuer URL을 입력하세요.',
                    issuerRequired: 'Issuer URL을 입력하세요.',
                    jwksRotation: '자동 JWKS 회전',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: '키 소스가 JWKS인 경우 비대칭 서명에 필요합니다.',
                    jwksURIInvalid: '선택한 서명 키 소스에 유효한 JWKS URI를 입력하세요.',
                    keepExistingRole: '기존 역할 및 로컬 권한 유지',
                    localSecurityData: '로컬 보안 데이터',
                    localSecurityDataPolicy: '역할, MFA, API Keys, Passkeys 또는 로컬 권한을 덮어쓰지 마십시오.',
                    localCredentialsManaged:
                        '사용자 이름과 로컬 비밀번호는 OIDC에서 관리하므로 여기에서 편집할 수 없습니다. 역할, 권한, MFA, API Keys 및 Passkeys는 로컬에 유지됩니다.',
                    localUserFields: '로컬 사용자 필드',
                    localUserFieldsDesc:
                        '첫 번째 릴리스에서는 User.Name만 매핑하고 JSON 매핑 표현식을 사용하지 않습니다.',
                    loginWith: '{provider}(으)로 로그인',
                    manualEndpoints: '사용자 지정 엔드포인트',
                    manualEndpointsDesc:
                        'Discovery가 불완전하거나 업스트림 게이트웨이가 엔드포인트를 다시 쓰는 경우에만 사용하십시오.',
                    mappingResult: '매핑 결과',
                    mode: '연결 모드',
                    modeRequired: '연결 모드를 선택하세요.',
                    nameClaim: '사용자 이름 Claim',
                    ...
                    pkceS256: 'S256(권장)',
                    plannedHandling: '계획된 처리',
                    privateNetworkIdP: '개인 네트워크 IdP',
                    privateNetworkIdPHelper:
                        '개인 주소를 명시적으로 허용합니다. 메타데이터, 루프백, 링크-로컬, 리디렉션 및 DNS 리바인딩은 차단된 상태로 유지됩니다.',
                    privateNetworkWarning: '이 인증 소스에 대해 개인 네트워크 액세스가 활성화되어 있습니다.',
                    protocolCompatibility: '프로토콜 호환성',
                    protocolCompatibilityDesc: 'ID Token 서명 검증은 비활성화할 수 없습니다.',
                    providerAndClient: '공급자 및 클라이언트',
                    providerAndClientDesc:
                        'Client Secret은 교체하거나 지울 수만 있으며 페이지에서 다시 표시하지 않습니다.',
                    providerCapabilities: '공급자 기능',
                    recentTestSuccess: '마지막 테스트 성공: {0}',
                    recommended: '권장',
                    rejectPlain: 'plain 거부됨',
                    replaceSecret: 'Client Secret 교체',
                    requestAndClaims: '요청 및 속성',
                    requestAndClaimsDesc: '권한 부여 범위, 사용자 정보 보완 및 요청 매개변수를 구성합니다.',
                    requestTimeout: '요청 시간 초과',
                    requestTimeoutRequired: '요청 시간 제한을 입력하세요.',
                    restore: '복원',
                    restored: '마지막으로 저장한 OIDC 설정을 복원했습니다.',
                    result: '결과',
                    rolesLoadFailed: '역할을 로드할 수 없습니다. 기본 역할을 선택하기 전에 다시 시도하세요.',
                    roleHandling: '역할 처리',
                    scenario: '시나리오',
                    scopes: '권한 부여 범위',
                    scopesHelper: 'openid를 포함해야 합니다. 여러 범위는 공백으로 구분하세요.',
                    scopesRequired: 'Scopes에는 openid가 포함되어야 합니다.',
                    seconds: '초',
                    secretClearHelper: '지운 후 OIDC를 다시 활성화하려면 새 Client Secret이 필요합니다.',
                    secretConfigured: '구성됨',
                    secretNotConfigured: '구성되지 않음',
                    secretPlaceholder: '새 Client Secret을 입력하세요',
                    secretReplaceHelper:
                        '저장하면 새 비밀 값으로 교체됩니다. OIDC Provider의 Client Secret도 함께 업데이트하세요.',
                    secretRequiredHelper: 'OIDC를 활성화하기 전에 Client Secret를 구성하세요.',
                    secretRequiredToEnable: 'OIDC를 활성화하기 전에 Client Secret를 구성하세요.',
                    secretSavedHelper: '암호화되어 저장됩니다. 비워 두면 현재 시크릿을 유지합니다.',
                    secretWaiting: '입력 대기 중',
                    secretWillClear: '삭제됩니다',
                    secretWillReplace: '대체됩니다',
                    signingAlgorithm: 'ID Token 서명 알고리즘',
                    signingAlgorithmHelper: '백엔드 보안 허용 목록에 있는 알고리즘만 사용할 수 있습니다.',
                    signingKey: '서명 키',
                    signingKeyClientSecret: 'Client Secret(HS256 전용)',
                    signingKeyJWKS: '자동 회전이 포함된 JWKS URI',
                    signingKeySource: '서명 키 소스',
                    ...
                    standardProtocolPolicyDesc:
                        '서명 기능은 자동으로 협상됩니다. 여기에는 서명 키가 입력되지 않습니다.',
                    staticSigningKey: '정적 서명 공개 키',
                    staticSigningKeyHelper: '공개 키 자료만 허용됩니다. 공급자 키가 변경되면 수동으로 교체하세요.',
                    staticSigningKeyPlaceholder: 'JWK, JWKS JSON 또는 PEM 공개 키를 붙여넣으세요.',
                    staticSigningKeyRequired: '정적 서명 공개 키를 제공하세요.',
                    staticSigningKeyWarning:
                        '정적 서명 키는 자동으로 회전할 수 없습니다. 공급자가 키를 회전하기 전에 업데이트하세요.',
                    settingLoadFailed: 'OIDC 설정을 로드할 수 없습니다',
                    settingLoadFailedHelper:
                        '현재 설정 위에 빈 기본 구성이 저장되지 않도록 양식이 잠겨 있습니다. 연결이 복구된 후 다시 시도하세요.',
                    subsequentLogin: '다음 로그인',
                    subsequentLoginPolicy:
                        'subject로 바인딩을 찾고 새 사용자 이름을 사용할 수 있는 경우에만 User.Name을 업데이트합니다.',
                    testBeforeBrowserTest: '브라우저 테스트 로그인을 시작하기 전에 현재 구성을 테스트하세요.',
                    testBeforeEnable: '구성 변경 사항을 저장하기 전에 현재 구성을 테스트하세요.',
                    testConfiguration: '구성 테스트',
                    testDiscovery: 'Discovery 테스트',
                    tlsCustomCA: 'HTTPS · 사용자 지정 CA 인증서',
                    tlsPrivateHTTP: 'HTTP · 개인 네트워크만 해당(위험)',
                    tlsPrivateHTTPWarning:
                        'HTTP는 전송 암호화를 제공하지 않으며 명시적으로 허용된 개인 대상으로 제한됩니다.',
                    tlsSkipVerify: 'HTTPS · 인증서 확인 건너뛰기(위험)',
                    tlsSystem: 'HTTPS · 시스템 인증서 확인(권장)',
                    tokenEndpoint: 'Token Endpoint',
                    tokenEndpointInvalid: '유효한 Token Endpoint를 입력하세요.',
                    transportSecurity: '전송 보안',
                    transportSecurityHelper:
                        'HTTPS 사용을 권장합니다. 사설 HTTP를 사용하려면 사설 네트워크 접근도 명시적으로 허용해야 합니다.',
                    unsavedChanges: '저장되지 않은 OIDC 설정이 있습니다.',
                    usedClaim: 'Claim 사용됨',
                ...
                saml2: {
                    ...
                    actionPending: '결과를 기다리는 중',
                    actionReject: '로그인 거부',
                    actionReuse: '연결된 사용자 사용',
                    assignDefaultRole: '기본 역할 할당: {role}',
                    basic: '기본 설정',
                    basicDesc: '대부분의 표준 SAML2 IdP에 필요한 일반 설정을 구성합니다.',
                    browserTest: '로그인 테스트',
                    browserTestConflict: '신원은 확인되었지만 사용자 이름이 충돌합니다',
                    browserTestConflictHelper: '매핑된 사용자 이름은 다른 신원에 속하므로 자동으로 연결하지 않습니다.',
                    browserTestExpired: '브라우저 테스트가 만료되었습니다.',
                    ...
                    browserTestSuccess: '공급자 확인 성공',
                    browserTestSuccessHelper: '사용자 또는 세션을 변경하지 않고 ID 매핑을 미리 보았습니다.',
                    browserTestTitle: 'SAML2 브라우저 테스트 로그인',
                    browserTestWaiting: '공급자 인증 대기 중',
                    browserTestWaitingHelper:
                        '새 브라우저 창에서 로그인을 완료하세요. 이 페이지는 자동으로 업데이트됩니다.',
                    certificateFileInvalid: '유효한 PEM, CRT 또는 CER 인증서 파일을 선택하세요.',
                    configured: '구성됨',
                    configurationFailedHelper: '테스트에 실패했습니다. 페이지에 현지화된 백엔드 오류만 표시됩니다.',
                    configurationNotTested: '현재 구성은 테스트되지 않았습니다.',
                    configurationPassed: '현재 구성이 보안 및 기능 검사를 통과했습니다.',
                    configurationStaleHelper: '인증에 민감한 설정이 변경되었습니다. 현재 초안을 다시 테스트하세요.',
                    configurationTestSuccess: 'SAML2 구성 테스트에 성공했습니다.',
                    configurationTesting: '현재 SAML2 구성 테스트 중...',
                    conflictLDAP: 'LDAP 사용자',
                    conflictLocal: '로컬 사용자',
                    conflictNone: '충돌 없음',
                    conflictOIDC: '다른 OIDC ID',
                    conflictSAML2: '다른 SAML2 ID',
                    conflictType: '충돌 유형',
                    credentialFileReadFailed: '자격 증명 파일을 읽을 수 없습니다.',
                    credentialFileTooLarge: '자격 증명 파일은 256 KiB를 초과할 수 없습니다.',
                    credentialsRequired: 'SP 개인 키와 인증서를 모두 구성하세요.',
                    defaultRole: '새 사용자 역할',
                    defaultRoleHelper:
                        '최초 생성 시에만 지정하며 이후 로그인에서는 로컬 역할, MFA 및 권한을 유지합니다.',
                    defaultRolePlaceholder: '역할 선택',
                    defaultRoleRequired: '유효한 기본 역할을 선택하세요.',
                    disableConfirm:
                        'SAML2를 비활성화하면 새 로그인이 즉시 거부되고 해당 사용자 세션이 무효화됩니다. 계속하시겠습니까?',
                    disableDiscardConfirm:
                        'SAML2를 비활성화하면 이 페이지의 저장되지 않은 다른 변경사항이 삭제되고 사용자 세션이 즉시 무효화됩니다. 계속하시겠습니까?',
                    disableTitle: 'SAML2 비활성화',
                    disabled: '비활성화',
                    enable: '활성화',
                    enabled: '활성화됨',
                    idpMetadata: 'IdP 메타데이터',
                    idpMetadataDesc: 'URL 또는 XML 중 하나를 입력합니다. 둘 다 있으면 URL이 우선합니다.',
                    keepExistingRole: '기존 역할 및 로컬 권한 유지',
                    loginWith: '{provider}(으)로 로그인',
                    mappingResult: '매핑 결과',
                    metadataRequired: 'IdP Metadata URL 또는 XML을 입력하세요.',
                    metadataURLHelper: '백엔드는 테스트 및 저장 중에 메타데이터를 다운로드하고 검증합니다.',
                    metadataURLInvalid: '자격 증명이나 프래그먼트가 없는 유효한 HTTPS 메타데이터 URL을 입력하세요.',
                    metadataURLRecommended: '메타데이터 URL(권장)',
                    metadataXML: '메타데이터 XML',
                    metadataXMLHelper: 'IdP가 접근 가능한 메타데이터 URL을 제공하지 않을 때 사용하세요.',
                    ...
                    or: '또는',
                    pageDesc: 'IdP Metadata로 기업 SSO를 연결하고 일반 설정을 한 페이지에서 완료합니다.',
                    plannedHandling: '계획된 처리',
                    privateKeyFileInvalid: '유효한 PEM 개인 키 파일을 선택하세요.',
                    recentTestSuccess: '마지막 테스트 성공: {0}',
                    restore: '복원',
                    restored: '마지막으로 저장한 SAML2 설정을 복원했습니다.',
                    roleHandling: '역할 처리',
                    rolesLoadFailed: '역할을 로드할 수 없습니다. 기본 역할을 선택하기 전에 다시 시도하세요.',
                    selectFile: '파일 선택',
                    serviceStatus: '서비스 상태',
                    serviceStatusDesc: 'SAML2를 활성화하려면 현재 구성이 테스트를 통과해야 합니다.',
                    settingLoadFailed: 'SAML2 설정을 로드할 수 없습니다',
                    settingLoadFailedHelper:
                        '현재 설정 위에 빈 기본 구성이 저장되지 않도록 양식이 잠겨 있습니다. 연결이 복구된 후 다시 시도하세요.',
                    spCertificate: 'SP 인증서',
                    spCertificateHelper: 'IdP가 로그인 및 로그아웃 요청을 검증할 수 있도록 SP 메타데이터에 게시됩니다.',
        ...
        node: {
            ...
            dashboardSetting: '개요 설정',
            keepOneDashboardComponent: '개요 섹션을 하나 이상 유지하세요',
        },
        customApp: {
            name: '사용자 정의 앱 저장소',
        ...
        vm: {
            ...
            disk: '디스크',
            overview: '개요',
            kvmUnavailable: '사용 가능한 KVM 하드웨어 가상화 기능을 찾지 못했습니다.',
            kvmCheckCpu: '호스트 CPU가 Intel VT-x 또는 AMD-V 가상화를 지원하는지 확인하세요.',
            kvmCheckBios: 'BIOS/UEFI에서 가상화 옵션을 활성화하세요.',
            kvmCheckModule: 'kvm, kvm_intel 또는 kvm_amd 커널 모듈이 올바르게 로드되었는지 확인하세요.',
            kvmCheckDevice:
                '/dev/kvm이 존재하며 현재 환경이 KVM을 지원하지 않는 컨테이너 또는 클라우드 호스트가 아닌지 확인하세요.',
            abnormal: '비정상',
            resourceOverview: '리소스 개요',
            cpuAllocated: '할당된 CPU',
            memoryAllocated: '할당된 메모리',
            storageUsed: '사용한 스토리지',
            riskReminder: '위험 알림',
            noRisk: '위험 없음',
            runtimeHealth: '실행 환경 상태',
            runtimeAbnormal: 'VM 실행 환경이 비정상입니다',
            noDependency: '종속성 검사 데이터가 없습니다',
            storageOverview: '스토리지 개요',
            totalAllocated: '전체 VM 구성 기준으로 계산',
            runningAllocated: '실행 중 할당량: {0}',
            storageAvailable: '사용 가능: {0}',
            inProgress: '진행 중',
            needAttention: '확인 필요',
            normal: '정상',
            environmentRisk: 'VM 실행 환경이 준비되지 않았습니다. 종속성 또는 가상화 서비스를 수정하세요.',
            storageRisk: '스토리지 풀 {0} 사용률이 {1}%에 도달했습니다.',
            abnormalRisk: '{0}개의 VM이 비정상 상태입니다.',
            pausedRisk: '{0}개의 VM이 일시 중지되었습니다.',
            memoryRisk: 'VM 메모리 할당률이 {0}%에 도달했습니다.',
            ...
            monitorLoadFailedWithReason: 'VM 모니터링 데이터를 가져오지 못했습니다: {0}',
            rename: '이름 변경',
            newName: '새 이름',
            renameHelper: '새 VM 이름을 입력하세요. 이름을 변경하기 전에 VM을 종료해야 합니다.',
            renameConfirm: '가상 머신 [{0}]의 이름을 [{1}](으)로 변경하시겠습니까?',
            renameRunningHelper: '이름을 변경하기 전에 가상 머신을 종료하세요.',
            cpuUsage: 'CPU 사용률',
            memoryUsage: '메모리 사용률',
            diskIO: '디스크 I/O',
            networkIO: '네트워크 I/O',
            diskReadWrite: '디스크 읽기/쓰기',
            networkRxTx: '네트워크 수신/송신',
            rx: 'RX',
            tx: 'TX',
            console: '콘솔',
            ...
            recoverSnapshot: '스냅샷 복구',
            snapshotSize: '사용량',
            currentSnapshot: '현재',
            snapshotEmpty: '스냅샷 없음',
            snapshotHelper:
                '스냅샷은 현재 VM 상태를 복원 지점으로 저장합니다. 이후 데이터 변경은 원본 디스크를 변경하지 않고 델타 파일에 기록됩니다. 스냅샷을 복구하면 VM이 해당 시점의 상태로 돌아갑니다.',
            snapshotOperationHelper:
                '현재 스냅샷은 삭제할 수 없습니다. 가상 머신이 종료된 경우에만 스냅샷을 복구할 수 있습니다.',
            snapshotRecoverConfirm:
                '가상 머신 [{1}]을(를) 스냅샷 [{0}](으)로 복구하시겠습니까? VM 디스크가 스냅샷 시점의 상태로 복원됩니다.',
