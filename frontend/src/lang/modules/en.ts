...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: 'This only saves the existing password to NexaCP and does not change it in MySQL.',
        ...
        loadFromRemoteHelper: 'Sync databases, users, and authorizations from the server to NexaCP. Continue?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'This model was not downloaded via NexaCP, no related pull logs.',
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Keep current validity',
            neverExpires: 'Never expires',
            validForDays: 'Valid for {0} days',
            customDays: 'Custom days',
            enterValidityDays: 'Enter the validity period in days',
            currentExpiresAt: 'Current expiration: {0}',
            currentNeverExpires: 'Currently never expires',
            ...
            upstreamDuration: 'Upstream Time',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Arguments are appended to the supergateway command. Transport, port, path, and protocol arguments managed by NexaCP cannot be changed',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Detected that the container is from the App Store. Deleting the container will not completely remove it from NexaCP. To delete it completely, go to the App Store -> 'Installed' or 'Runtime Environment' menus. Continue?",
        start: 'Start',
        stop: 'Stop',
        restart: 'Restart',
        kill: 'Kill',
        ...
        composeHelper:
            'The composition created through NexaCP editor or template will be saved in the {0}/docker/compose directory.',
        ...
        running: 'Running ( {0} / {1} )',
        composeDetailHelper:
            'The compose is created external to NexaCP. The start and stop operations are not supported.',
        ...
        composeEnvHelper2:
            'This orchestration was created by the NexaCP App Store. Please modify environment variables in the installed applications.',
    ...
    cronjob: {
        ...
        logHelper1: '1. NexaCP system log',
        ...
        cutWebsiteLogHelper: 'The rotated log files will be backed up to the backup directory of NexaCP.',
    ...
    file: {
        ...
        panelInstallDir: "NexaCP installation directory can't be deleted",
    ...
    setting: {
        ...
        timeZoneHelper:
            'Timezone modification depends on the system timedatectl service. take effect after restart the NexaCP service.',
        timeZoneCN: 'Bei Jing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'NexaCP domain binding configured',
        ...
        bindDomainHelper: 'After you bind the domain, only that domain can access NexaCP service.',
        bindDomainHelper1: 'Leave it blank to disable the domain name binding.',
        bindDomainWarning:
            'After domain binding, you will be logged out and can only access NexaCP service through the domain name specified in the settings. Continue?',
        ...
        mfaTitleHelper:
            'The title is used to distinguish different NexaCP hosts. Scan again or manually add the secret key after you modify the title.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'This rule will be used to compress and backup the NexaCP data directory during creating snapshot. By default, socket files are ignored.',
        ignoreHelper1: 'One per line. For example,\n*.log\n/opt/1panel/cache',
        panelInfo: 'Write NexaCP basic information',
        panelBin: 'Backup NexaCP system files',
        daemonJson: 'Backup Docker configuration file',
        appData: 'Backup installed apps from NexaCP',
        panelData: 'Backup NexaCP data directory',
        backupData: 'Backup local backup directory for NexaCP',
        ...
        recoverHelper1: 'Recovery requires restarting Docker and NexaCP services',
        recoverHelper2:
        ...
        rollback: 'Rollback',
        rollbackHelper:
            'Rolling back this recovery will replace all files from this recovery, and may require restarting Docker and NexaCP services. Continue?',
        upgradeRecord: 'Upgrade record',
        upgrading: 'Upgrading, please wait...',
        upgradeHelper: 'The upgrade requires restarting the NexaCP service. Continue?',
    ...
    license: {
        ...
        securityWarningContent:
            'NexaCP runs with system administration privileges. Unofficial licenses or tampered builds may cause server takeover, data leaks, and other serious security risks. Obtain licenses and installers only from official FIT2CLOUD channels.',
        ...
        node: 'Upgrade to Commercial Edition to manage multiple Linux servers in NexaCP.',
        ...
        vllm: 'Upgrade to Commercial Edition to manage vLLM services in NexaCP with centralized deployment, configuration, lifecycle operations, and task tracking.',
        'model-downloader':
    ...
    clean: {
        scan: 'Start scanning',
        scanHelper: 'Easily clean up junk files produced during NexaCP runtime',
        clean: 'Clean now',
        reScan: 'Rescan',
    ...
    ssl: {
        ...
        shellHelper:
            'The default execution directory of the script is the NexaCP installation directory. If a certificate is pushed into local directory, the execution directory will be the certificate push directory. The default execution timeout is 30 minutes.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'This will modify "files" value in "[include"] section in the main configuration file. The directory of other configuration file will be: "{NexaCP installation directory}/1panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreWebsiteMonitorAvailability: 'Website monitoring request availability {0}% is below the threshold',
                ...
                waf: 'WAF',
                siteAvailability: 'Request Availability',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: 'Connection mode',
                    accessModeDesc: 'Use standard Discovery whenever the identity provider supports it.',
                    actionCreate: 'Create user',
                    actionKeepName: 'Keep the current name',
                    actionPending: 'Waiting for result',
                    actionReject: 'Reject login',
                    actionUpdate: 'Update identity information',
                    advanced: 'Advanced settings',
                    advancedDesc: 'Keep the secure defaults unless the provider requires a compatibility option.',
                    assignDefaultRole: 'Assign default role: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Enter a valid Authorization Endpoint.',
                    authorizationFlow: 'Authorization flow',
                    automatic: 'Automatic',
                    automaticPolicy: 'Automatic handling policy',
                    automaticPolicyDesc: 'These rules are enforced by the backend and are not administrator switches.',
                    basic: 'Basic settings',
                    basicDesc: 'Select the provider mode, then configure the client and callback.',
                    browserTest: 'Browser test login',
                    browserTestConflict: 'Identity verified, but the name conflicts',
                    browserTestConflictHelper: 'The mapped name belongs to another identity and will not be claimed.',
                    browserTestExpired: 'Browser test expired',
                    browserTestExpiredHelper: 'Start a new browser test and complete authorization before it expires.',
                    browserTestFailed: 'Browser test failed',
                    browserTestFailedHelper:
                        'The identity preview could not be completed. Review the localized backend error.',
                    browserTestIsolation:
                        'This performs a real authorization round trip but does not create or update users, assign roles, or create an authenticated panel session.',
                    browserTestPopupBlocked: 'Allow pop-ups for this site, then start the browser test again.',
                    browserTestPopupClosed: 'The authorization window was closed before the test completed.',
                    browserTestSuccess: 'Provider verification succeeded',
                    browserTestSuccessHelper: 'Identity mapping was previewed without changing users or sessions.',
                    browserTestTitle: 'OIDC browser test login',
                    browserTestWaiting: 'Waiting for Provider authorization',
                    ...
                    clockSkewHelper:
                        'Allows a small time difference between the identity provider and NexaCP. Keep the default 60 seconds.',
                    ...
                    configurationHighRiskPassed:
                        'The configuration passed, but contains high-risk compatibility options.',
                    configurationHighRiskTag: 'High-risk configuration passed',
                    configurationNotTested: 'The current configuration has not been tested.',
                    ...
                    configurationTestResult: 'Configuration test result',
                    configurationTestResultDesc:
                        'This checks Discovery and capabilities only; it does not exchange an authorization code or prove the Client Secret. Use browser test login for end-to-end verification.',
                    configurationTestSuccess: 'OIDC configuration test succeeded.',
                    configurationTesting: 'Testing the current OIDC configuration…',
                    configurationTestingTag: 'Testing',
                    configureSecret: 'Configure secret',
                    conflictExistingRename: 'A bound subject returns a new name that is occupied',
                    conflictExistingRenameResult: 'Keep the existing User.Name and allow the bound user to sign in',
                    conflictLDAP: 'LDAP user',
                    conflictLocal: 'Local user',
                    conflictNewAvailable: 'New subject and the mapped name are available',
                    conflictNewAvailableResult: 'Create an enterprise user and assign the default role',
                    conflictNone: 'No conflict',
                    conflictOIDC: 'Another OIDC identity',
                    conflictOccupied: 'The mapped name belongs to a local, LDAP, or another OIDC identity',
                    conflictOccupiedResult: 'Reject the new identity; never bind or merge automatically',
                    ...
                    customCA: 'Custom CA',
                    customCAHelper: 'Applies only to this authentication source and is never written to logs.',
                    ...
                    disableConfirm: 'Disabling OIDC immediately invalidates access for users of this source. Continue?',
                    disableDiscardConfirm:
                        'Disabling OIDC is an emergency action: it only closes the login entry and immediately invalidates access for users of this source. Other unsaved changes on this page, including Client Secret changes, will be discarded. Continue?',
                    disableTitle: 'Disable OIDC',
                    disabled: 'Disabled',
                    discoveryAllowlist: 'Discovery ∩ security allowlist',
                    enable: 'Enable',
                    enableAfterSave: 'OIDC will be enabled after a successful save.',
                    enabled: 'Enabled',
                    ...
                    fixedNoTokenPersistence: 'Tokens, Claims, and the verifier are never persisted',
                    fixedSecurityPolicy: 'Always enforced; no configuration required',
                    fixedStateNonce: 'One-time state and nonce',
                    fixedTokenValidation: 'ID Token signature and Claims validation',
                    highRiskSaveConfirm:
                        'This enabled configuration contains high-risk compatibility options. Confirm that the isolated environment requires them.',
                    highRiskTitle: 'High-risk OIDC configuration',
                    hs256Compatibility: 'HS256 (compatibility)',
                    hs256KeyHelper:
                        'HS256 always uses this source’s Client Secret and does not accept a separate signing key.',
                    hs256Warning:
                        'HS256 uses a shared symmetric secret for ID Token signatures. Use it only when the Provider cannot use an asymmetric algorithm.',
                    identityBindingPolicy:
                        'Identity is fixed to AuthSourceID + issuer + subject. A matching user name never claims another account.',
                    identityMissing: 'Identity inactive',
                    issuer: 'Issuer URL',
                    issuerHelper: 'The ID Token iss value and Discovery issuer must match this value exactly.',
                    issuerInvalid: 'Enter a valid HTTP or HTTPS Issuer URL without query or fragment.',
                    issuerRequired: 'Enter the Issuer URL.',
                    jwksRotation: 'Automatic JWKS rotation',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Required for asymmetric signing when the key source is JWKS.',
                    jwksURIInvalid: 'Enter a valid JWKS URI for the selected signing key source.',
                    keepExistingRole: 'Keep existing roles and local permissions',
                    localSecurityData: 'Local security data',
                    localSecurityDataPolicy: 'Never overwrite roles, MFA, API Keys, Passkeys, or local permissions.',
                    localCredentialsManaged:
                        'The user name and local password are managed by OIDC and cannot be edited here. Roles, permissions, MFA, API Keys, and Passkeys remain local.',
                    localUserFields: 'Local user fields',
                    localUserFieldsDesc:
                    ...
                    panelURL: 'NexaCP public URL',
                    panelURLHTTPWarning:
                        'HTTP does not protect the authorization response. Use it only in an isolated private environment accepted by the Provider.',
                    panelURLHelper:
                        'Enter the address users use to access NexaCP. It is used to generate the callback URL.',
                    panelURLInvalid: 'Enter an origin containing only scheme, host, and optional port.',
                    panelURLRequired: 'Enter the NexaCP public URL.',
                    pkceDisabled: 'Disabled (compatibility only)',
                    pkceDisabledWarning: 'Disabling PKCE reduces protection against authorization-code interception.',
                    pkceHelper: 'Prefer S256. The plain challenge method is never offered.',
                    pkceS256: 'S256 (recommended)',
                    plannedHandling: 'Planned handling',
                    privateNetworkIdP: 'Private-network IdP',
                    privateNetworkIdPHelper:
                        'Explicitly permits private addresses; metadata, loopback, link-local, redirects, and DNS rebinding remain blocked.',
                    privateNetworkWarning: 'Private-network access is enabled for this authentication source.',
                    protocolCompatibility: 'Protocol compatibility',
                    protocolCompatibilityDesc: 'ID Token signature validation can never be disabled.',
                    providerAndClient: 'Provider and client',
                    providerAndClientDesc:
                        'The Client Secret can only be replaced or cleared and is never returned by the page.',
                    ...
                    restore: 'Restore',
                    restored: 'The last saved OIDC settings were restored.',
                    result: 'Result',
                    ...
                    seconds: 'seconds',
                    secretClearHelper:
                        'After clearing, a new Client Secret is required before OIDC can be enabled again.',
                    ...
                    signingAlgorithm: 'ID Token signing algorithm',
                    signingAlgorithmHelper: 'Only algorithms in the backend security allowlist are available.',
                    signingKey: 'Signing key',
                    signingKeyClientSecret: 'Client Secret (HS256 only)',
                    signingKeyJWKS: 'JWKS URI with automatic rotation',
                    signingKeySource: 'Signing key source',
                    signingKeySourceHelper: 'Prefer JWKS. A static public key cannot rotate automatically.',
                    signingKeyStatic: 'Static JWK or PEM public key',
                    standardDiscovery: 'Standard OIDC Discovery',
                    standardDiscoveryDesc:
                        'NexaCP discovers endpoints and capabilities and does not store the raw document.',
                    ...
                    standardProtocolPolicyDesc:
                        'Signing capabilities are negotiated automatically; no signing key is entered here.',
                    staticSigningKey: 'Static signing public key',
                    staticSigningKeyHelper:
                        'Only public-key material is accepted. Rotate it manually when the Provider key changes.',
                    staticSigningKeyPlaceholder: 'Paste a JWK, JWKS JSON, or PEM public key',
                    staticSigningKeyRequired: 'Provide the static signing public key.',
                    staticSigningKeyWarning:
                        'A static signing key cannot rotate automatically; update it before the Provider rotates keys.',
                    settingLoadFailed: 'OIDC settings could not be loaded',
                    settingLoadFailedHelper:
                        'The form is locked to avoid saving an empty default configuration over the current settings. Retry after the connection recovers.',
                    subsequentLogin: 'Subsequent login',
                    ...
                    tlsPrivateHTTP: 'HTTP · Private network only (dangerous)',
                ...
                saml2: {
                    actionCreate: 'Create user',
                    actionPending: 'Waiting for result',
                    actionReject: 'Reject sign-in',
                    actionReuse: 'Use bound user',
                    assignDefaultRole: 'Assign default role: {role}',
                    basic: 'Basic settings',
                    basicDesc: 'Configure the common options required by most standard SAML2 identity providers.',
                    browserTest: 'Test sign-in',
                    browserTestConflict: 'Identity verified, but the username conflicts',
                    browserTestConflictHelper:
                        'The mapped username belongs to another identity and will not be linked automatically.',
                    browserTestExpired: 'Browser test expired',
                    browserTestExpiredHelper: 'Start a new test and complete sign-in before it expires.',
                    browserTestFailed: 'Browser test failed',
                    browserTestFailedHelper:
                        'The identity preview could not be completed. Check the localized backend error.',
                    browserTestIsolation:
                        'Performs a real SAML2 round trip without creating users, assigning roles, or creating a session.',
                    browserTestPopupBlocked: 'Allow pop-ups for this site, then run the test again.',
                    browserTestPopupClosed: 'The sign-in window was closed before the test completed.',
                    browserTestSuccess: 'SAML2 identity verified',
                    browserTestSuccessHelper:
                        'The identity mapping preview completed without modifying users or sessions.',
                    browserTestTitle: 'SAML2 test sign-in',
                    browserTestWaiting: 'Waiting for IdP sign-in',
                    browserTestWaitingHelper: 'Complete sign-in in the new window. This page updates automatically.',
                    certificateFileInvalid: 'Select a valid PEM, CRT, or CER certificate file.',
                    configured: 'Configured',
                    configurationFailedHelper: 'The test failed. Only the localized backend error is displayed.',
                    configurationNotTested: 'The current configuration has not been tested.',
                    configurationPassed: 'The current configuration passed validation.',
                    configurationStaleHelper: 'Authentication settings changed. Test the current draft again.',
                    configurationTestSuccess: 'SAML2 configuration test succeeded.',
                    configurationTesting: 'Testing the current SAML2 configuration…',
                    conflictLDAP: 'LDAP user',
                    conflictLocal: 'Local user',
                    conflictNone: 'No conflict',
                    conflictOIDC: 'OIDC identity',
                    conflictSAML2: 'Another SAML2 identity',
                    conflictType: 'Conflict type',
                    credentialFileReadFailed: 'The credential file could not be read.',
                    credentialFileTooLarge: 'Credential files must not exceed 256 KiB.',
                    credentialsRequired: 'Configure both the SP private key and certificate.',
                    defaultRole: 'New user role',
                    defaultRoleHelper:
                        'Assigned only when the user is first created. Later sign-ins keep local roles, MFA, and permissions.',
                    defaultRolePlaceholder: 'Select a role',
                    defaultRoleRequired: 'Select a valid new-user role.',
                    disableConfirm:
                        'Disabling SAML2 immediately rejects new sign-ins and invalidates its user sessions. Continue?',
                    disableDiscardConfirm:
                        'Disabling SAML2 discards other unsaved changes on this page and immediately invalidates its user sessions. Continue?',
                    disableTitle: 'Disable SAML2',
                    disabled: 'Disabled',
                    enable: 'Enable',
                    enabled: 'Enabled',
                    idpMetadata: 'IdP Metadata',
                    idpMetadataDesc: 'Enter a URL or paste XML. When both are present, the URL takes precedence.',
                    keepExistingRole: 'Keep the existing role and local permissions',
                    loginWith: 'Sign in with {provider}',
                    mappingResult: 'Mapping result',
                    metadataRequired: 'Enter an IdP Metadata URL or XML.',
                    metadataURLHelper: 'The backend downloads and validates Metadata during testing and saving.',
                    metadataURLInvalid: 'Enter a valid HTTPS Metadata URL without credentials or a fragment.',
                    metadataURLRecommended: 'Metadata URL (recommended)',
                    metadataXML: 'Metadata XML',
                    metadataXMLHelper: 'Use this when the IdP does not expose a reachable Metadata URL.',
                    metadataXMLInvalid: 'Enter valid EntityDescriptor Metadata XML.',
                    metadataXMLPlaceholder: 'Paste <EntityDescriptor>...</EntityDescriptor>',
                    nameAttribute: 'Username attribute',
                    nameAttributeHelper:
                        'Reads this Attribute from the verified SAML Assertion and maps it to the NexaCP username.',
                    nameAttributePlaceholder: 'For example: uid, username, or account',
                    nameAttributeRequired: 'Enter the username attribute.',
                    notConfigured: 'Not configured',
                    or: 'or',
                    pageDesc:
                        'Connect enterprise single sign-on through IdP Metadata with the common settings on one page.',
                    plannedHandling: 'Planned handling',
                    privateKeyFileInvalid: 'Select a valid PEM private-key file.',
                    recentTestSuccess: 'Last successful test: {0}',
                    restore: 'Restore',
                    restored: 'Restored the last saved SAML2 configuration.',
                    roleHandling: 'Role handling',
                    rolesLoadFailed: 'Failed to load roles. Retry before selecting the new-user role.',
                    selectFile: 'Select file',
                    serviceStatus: 'Service status',
                    serviceStatusDesc: 'The current configuration must pass a test before SAML2 can be enabled.',
                    settingLoadFailed: 'Failed to load SAML2 settings',
                    settingLoadFailedHelper:
                        'The form is locked to avoid overwriting saved settings with empty defaults. Retry after connectivity is restored.',
                    spCertificate: 'SP certificate',
                    spCertificateHelper: 'Published in SP Metadata so the IdP can verify sign-in and logout requests.',
                    ...
                    syncLogout: 'Synchronized logout',
                    syncLogoutHelper:
                        'Signing out of either NexaCP or the identity provider also signs out the other side.',
                    testBeforeBrowserTest: 'Test the current configuration before running a browser sign-in test.',
                    testBeforeEnable:
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Set the user search base and filter, then map the LDAP attribute used as the NexaCP name.',
                    ...
                    attributeMapTooltip: 'JSON mapping from the NexaCP name field to an LDAP attribute.',
                    attributeMapHelper: 'Set the LDAP attribute mapped to the NexaCP name field.',
                    advanced: 'Advanced settings',
                    ...
                    sync: {
                        ...
                        description:
                            'Read the full LDAP directory on a schedule and maintain imported LDAP users in NexaCP.',
                    ...
                    testLoginDesc:
                        'Bind with an AD/LDAP user credential to test authentication only. No NexaCP session is created.',
        ...
        helper: {
            ...
            settingContent1: 'Set a custom welcome message on the NexaCP login page.',
            ...
            appContent1: 'Easily manage your NexaCP server anytime, anywhere.',
            ...
            vllmContent1:
                'Bring scattered vLLM services into NexaCP for unified visibility of instances, versions, status, and runtime paths.',
        ...
        node: {
            ...
            panelExist:
                'Detected that this node is running NexaCP V1 service. Please upgrade to V2 using the migration script before adding.',
            coreExist:
            ...
            oldDataExist:
                'Detected historical NexaCP V2 data on this node. The following information will be used to overwrite current settings:',
            ...
            uninstallHelper: 'This will delete all NexaCP related data of the node. Proceed with caution!',
