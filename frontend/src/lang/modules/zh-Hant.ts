...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: '僅將現有密碼儲存到 NexaCP，不會修改 MySQL 使用者密碼。',
        noUserBind: '未綁定',
        pgBindHelper: '此操作用於建立新使用者並將其綁定到目標資料庫，暫不支援選擇已存在於資料庫中的使用者。',
        pgSuperUser: '超級使用者',
        loadFromRemoteHelper: '此操作將同步伺服器上的資料庫、使用者及授權資訊到 NexaCP，是否繼續？',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: '該模型並非透過 NexaCP 下載，無相關拉取日誌。',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '參數將附加到 supergateway 啟動命令，不支援修改由 NexaCP 管理的傳輸、連接埠、路徑和協議參數',
            testConnection: '測試連線',
    ...
    container: {
        ...
        containerDeleteHelper:
            '偵測到容器來源於應用商店，刪除容器不會將其從 NexaCP 中完全移除。如需徹底刪除，請前往應用商店-『已安裝』或『運行環境』等選單中操作。是否繼續？',
        start: '啟動',
        stop: '停止',
        restart: '重新啟動',
        kill: '強制停止',
        ...
        composeHelper: '通過 NexaCP 編輯或範本建立的編排，將儲存在 {0}/docker/compose 路徑下',
        deleteFile: '刪除檔案',
        ...
        exited: '已停止',
        running: '執行中 ( {0} / {1} )',
        composeDetailHelper: '該 compose 為 NexaCP 編排外部建立。暫不支援啟停操作。',
        composeOperatorHelper: '將對 {0} 進行 {1} 操作，是否繼續？',
        composeDownHelper: '將停止並刪除 {0} 編排下所有容器及網路，是否繼續？',
        composeEnvHelper2: '該編排為 NexaCP 應用商店建立，請在已安裝應用中修改環境變數。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日誌檔案會備份到 NexaCP 的 backup 目錄下',
    ...
    file: {
        ...
        previewLargeFile: '預覽',
        panelInstallDir: 'NexaCP 安裝目錄不能刪除',
        wgetTask: '下載任務',
    ...
    setting: {
        ...
        timeZoneHelper: '時區修改依賴系統 timedatectl 服務，重新啟動 NexaCP 服務後生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉磯',
        timeZoneNY: '紐約',
        ntpALi: '阿里雲',
        ...
        developerModeHelper: '取得 NexaCP 的預覽版本，以分享有關新功能和更新的回饋',
        thirdParty: '第三方帳號',
        scope: '使用範圍',
        public: '公有',
        ...
        ignoreHelper: '快照時將使用該規則對 NexaCP 資料目錄進行壓縮備份，請謹慎修改。',
        ignoreHelper1: '一行一個，例： \n*.log\n/opt/1panel/cache',
        status: '快照狀態',
        panelInfo: '寫入 NexaCP 基礎資訊',
        panelBin: '備份 NexaCP 系統檔案',
        daemonJson: '備份 Docker 設定檔',
        appData: '備份 NexaCP 已安裝應用',
        panelData: '備份 NexaCP 資料目錄',
        backupData: '備份 NexaCP 本機備份目錄',
        compress: '製作快照檔案',
        upload: '上傳快照檔案',
        recoverDetail: '復原詳情',
        ...
        recoverHelper1: '復原需要重新啟動 Docker 以及 NexaCP 服務',
        ...
        rollback: '回滾',
        rollbackHelper:
            '即將回滾本次復原，回滾將取代所有本次復原的檔案，過程中可能需要重新啟動 Docker 以及 NexaCP 服務，是否繼續？',
        upgradeRecord: '升級記錄',
        upgrading: '正在升級中，請稍候',
        upgradeHelper: '升級操作需要重新啟動 NexaCP 服務，是否繼續？',
        noUpgrade: '已是最新版本',
        versionHelper: 'NexaCP 版本號命名規則為： [大版本].[功能版本].[Bug 修復版本]，例：',
        ...
        passkeyPrereqBindDomain: '已設定 NexaCP 網域綁定',
        ...
        bindDomainHelper: '設定網域綁定後，僅能透過設定中域名存取 NexaCP 服務',
        bindDomainHelper1: '綁定域名為空時，則取消網域綁定',
        bindDomainWarning: '設定網域綁定後，將退出目前登入，且僅能透過設定中域名存取 NexaCP 服務，是否繼續？',
        allowIPs: '授權 IP',
        unAllowIPs: '取消授權',
        unAllowIPsWarning: '授權 IP 為空將允許所有 IP 存取系統，可能造成系統不安全，是否繼續？',
        allowIPsHelper: '設定授權 IP 後，僅有設定中的 IP 可以存取 NexaCP 服務',
        allowIPsWarning: '設定授權 IP 後，僅有設定中的 IP 可以存取 NexaCP 服務，是否繼續？',
        ...
        mfaTitleHelper: '用於區分不同 NexaCP 主機，修改後請重新掃描或手動新增金鑰資訊',
        mfaIntervalHelper:
    ...
    license: {
        ...
        securityWarningContent:
            'NexaCP 需要以具備系統管理權限的使用者執行，非官方許可證或被竄改版本可能導致伺服器失控、資料外洩等嚴重安全風險。請透過飛致雲官方管道取得許可證和安裝包。',
        ...
        node: '升級商業版可以使用 NexaCP 管理多台 Linux 伺服器。',
        ...
        vllm: '升級商業版可將 vLLM 服務統一納入 NexaCP 管理，集中完成部署、設定調整、狀態維運與任務追蹤，降低本地模型服務維護成本。',
        'model-downloader':
            '升級商業版可從 HuggingFace、ModelScope 或相容鏡像站搜尋、下載並管理本機模型檔案，統一維護本機模型目錄與下載任務。',
    },
    clean: {
        scan: '開始掃描',
        scanHelper: '輕鬆梳理 NexaCP 執行期間積累的垃圾檔案',
        clean: '立即清理',
        reScan: '重新掃描',
    ...
    website: {
        ...
        websiteDeploymentHelper: '使用從 NexaCP 部署的應用建立網站',
        ...
        wafValueHelper: '值',
        runtimeProxyHelper: '使用從 NexaCP 建立的執行環境',
        runtime: '執行環境',
    ...
    ssl: {
        ...
        shell: '腳本內容',
        shellHelper:
            '腳本預設執行目錄為 NexaCP 安裝目錄，如果有推送憑證，那麼執行目錄為憑證推送目錄。預設逾時時間 30 分鐘',
    ...
    xpack: {
        ...
        helper: {
            ...
            settingTitle1: '自訂歡迎語',
            settingContent1: '在 NexaCP 登入頁上設定自訂的歡迎語。',
            ...
            appTitle1: '靈活管理面板',
            appContent1: '隨時隨地輕鬆管理你的 NexaCP 伺服器。',
            appTitle2: '全面服務資訊',
            ...
            vllmTitle1: '統一納管',
            vllmContent1: '將分散的 vLLM 服務統一接入 NexaCP，集中檢視實例、版本、狀態與執行目錄。',
            vllmTitle2: '快速部署',
        ...
        node: {
            ...
            checkPort: '檢查節點埠可達',
            panelExist: '檢查到該節點正在執行 NexaCP V1 服務，請先透過遷移腳本升級至 V2 後再進行新增。',
            coreExist:
            ...
            oldDataExist: '檢查到該節點存在 NexaCP V2 歷史資料，將使用以下資訊覆蓋目前設定',
            ...
            uninstall: '刪除節點資料',
            uninstallHelper: '此操作將刪除與節點相關的所有 NexaCP 資料，請謹慎選擇',
