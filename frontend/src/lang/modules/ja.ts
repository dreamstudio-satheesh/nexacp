...
const message = {
    commons: {
        ...
        rule: {
            ...
            nginxDoc: 'このフィールドは、英語、数字、「.」「_」「-」で構成されている必要があります。',
            appName:
            ...
            vmName: '英字、数字、"."、"-"、"_"を使用できます。長さは1～64文字で、英字または数字で始める必要があります。',
            vmNetwork:
                '英字、数字、"."、":"、"-"、"_"を使用できます。長さは1～64文字で、英字または数字で始める必要があります。',
    ...
    home: {
        ...
        loadAverage: '直近1分の平均負荷 | 直近{0}分の平均負荷',
        load: '負荷',
        mount: 'マウントポイント',
        fileSystem: 'ファイルシステム',
        total: '合計',
    ...
    database: {
        ...
        deleteUserHelper: '「このユーザーを削除するには入力してください',
    ...
    aiTools: {
        agents: {
            ...
            roleMarkdownDescriptions: {
                ...
                'SOUL.md': ['人格、口調、境界線。'],
                'USER.md': ['ユーザーが誰で、どう呼びかけるか。'],
                'IDENTITY.md': ['エージェントの名前、雰囲気、絵文字。'],
                'TOOLS.md': ['ローカルツールや運用上の約束に関するメモ。'],
                'HEARTBEAT.md': [
                ...
                'BOOTSTRAP.md': ['初回起動時だけの儀式です。', 'まったく新しいワークスペースでのみ作成されます。'],
            },
        ...
        aiProxy: {
            ...
            lastUsedAt: '最終使用日時',
            validityPeriod: '有効期間',
            keepCurrentValidity: '現在の有効期間を維持',
            neverExpires: '無期限',
            validForDays: '{0} 日間有効',
            customDays: '日数を指定',
            enterValidityDays: '有効日数を入力してください',
            currentExpiresAt: '現在の有効期限：{0}',
            currentNeverExpires: '現在は無期限です',
            expiresAt: '有効期限',
            expired: '期限切れ',
            reactivate: '再有効化',
            ...
            currentLimit: '現在 / 上限',
            utilization: '使用率',
            autoRefreshSeconds: '{0} 秒ごとに自動更新',
            zeroMeansUnlimited: '0 に設定すると無制限になります。',
            groupMaxConcurrencyDesc: 'グループ内の全 API Key のアクティブリクエスト数を制限します。0 は無制限です。',
            apiKeyMaxConcurrencyDesc: 'グループ内の各 API Key のアクティブリクエスト数を制限します。0 は無制限です。',
            schedulingReason: 'スケジューリング理由',
            schedulingAffinity: 'アフィニティ',
            schedulingLeastUtilized: '最低利用率',
            schedulingPriorityFallback: '優先度フォールバック',
            schedulingRetry: '再試行',
            queueSize: 'キューサイズ',
            ...
            severityLow: '低',
            sensitiveWord: '機密語',
            sensitiveGroup: '機密語グループ',
            sensitiveWordCount: '語数',
            normalizedWord: '正規化された語',
            matchedWords: '一致した語',
            matchedGroups: '一致したグループ',
    ...
    container: {
        ...
        lastHour: '最後の時間',
        last10Min: '最後の10分',
        cleanLogscope: 'クリーンアップ種別',
        cleanLog: 'クリーンログ',
        downLogHelper1: 'これにより、Container {0}からすべてのログをダウンロードします。続けたいですか？',
        downLogHelper2: 'コンテナ {0} から最新の {1} 行のログをダウンロードします。続行しますか？',
        ...
        auth: '認証が必要です',
        mirrorHelper:
            '複数のミラーがある場合は1行に1つ入力します。例：\nhttp://xxxxxx.m.daocloud.io\nhttps://xxxxxx.mirror.aliyuncs.com',
        registrieHelper:
            '複数のプライベートレジストリがある場合は1行に1つ入力します。例：\n172.16.10.111:8081\n172.16.10.112:8081',
        compose: '構成|作曲',
        composeFile: 'オーケストレーションファイル',
        fromChangeHelper: 'ソースを切り替えると、現在の編集されたコンテンツがきれいになります。続けたいですか？',
        composePathHelper:
            'Compose ファイルの保存パス：{0}。Docker Compose でプロジェクト名が指定されている場合はその名前を優先し、指定されていない場合は {1} を使用します。',
        ...
        goSetting: '設定へ',
        mirrorsHelper:
            'イメージ操作ではレジストリミラー URL を優先して使用します。空欄にするとレジストリミラーを無効にします。',
    },
    cronjob: {
        importHelper:
    ...
    toolbox: {
        ...
        device: {
            ...
            dnsHelper1: '複数の DNS を設定する場合は1行に1つ入力します。例：\n114.114.114.114\n8.8.8.8',
            hostsHelper: 'ホスト名解像度',
            hosts: 'ドメイン',
    ...
    ssh: {
        ...
        listenHelper: 'IPv4 と IPv6 の両方を空欄にすると、0.0.0.0:{0}（IPv4）および :::{0}（IPv6）で待ち受けます。',
    ...
    setting: {
        ...
        code: '認証コード',
        codeHelper:
            '「取得」をクリックし、{0} にログインします。リダイレクト先 URL の「code」以降をコピーしてこの入力欄に貼り付けてください。詳しい手順は公式ドキュメントを参照してください。',
        googleHelper:
    ...
    clean: {
        ...
        appTmpDownload: 'アプリ一時ダウンロードファイル',
    ...
    website: {
        ...
        SSLHelper:
            '注意：違法な Web サイトに SSL 証明書を使用しないでください。\n有効化後に HTTPS でアクセスできない場合は、セキュリティグループでポート 443 が許可されているか確認してください。',
        SSLConfig: '証明書設定',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreSSLExpired: '{0} 証明書の有効期限が切れています',
                scoreSSLHigh: '{0} 証明書残り {1} 日',
                scoreSSLMedium: '{0} 証明書残り {1} 日',
                scoreWebsiteExpired: '{0} Web サイトの有効期限が切れています',
                ...
                scoreWebsiteMonitorAvailability: 'Webサイト監視リクエスト可用率 {0}% がしきい値を下回っています',
                ...
                serviceEnabledButAbnormal: '有効ですが、異常な状態です',
                ...
                disabledCronjobTasks: '無効なスケジュールタスク',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: '接続モード',
                    accessModeDesc:
                        'アイデンティティ プロバイダーがサポートする場合は常に標準の Discovery を使用します。',
                    actionCreate: 'ユーザーの作成',
                    actionKeepName: '現在のユーザー名を保持',
                    actionPending: '結果を待機中',
                    actionReject: 'ログインの拒否',
                    actionUpdate: 'アイデンティティ情報の更新',
                    advanced: '詳細設定',
                    advancedDesc: 'プロバイダーが互換性オプションを必要としない限り、安全なデフォルトを維持します。',
                    assignDefaultRole: 'デフォルトのロールの割り当て: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: '有効な Authorization Endpoint を入力してください。',
                    authorizationFlow: '認証フロー',
                    automatic: '自動',
                    automaticPolicy: '自動処理ポリシー',
                    automaticPolicyDesc: 'これらのルールはバックエンドによって適用され、管理者スイッチではありません。',
                    basic: '基本設定',
                    basicDesc: 'プロバイダー モードを選択し、クライアントとコールバックを設定します。',
                    browserTest: 'ブラウザーテストログイン',
                    browserTestConflict: 'ID は確認されましたが、ユーザー名が競合しています。',
                    browserTestConflictHelper:
                        'マッピングされたユーザー名は別の ID に属するため、自動的に関連付けません。',
                    browserTestExpired: 'ブラウザ テストの有効期限が切れました。',
                    browserTestExpiredHelper:
                        '新しいブラウザ テストを開始し、有効期限が切れる前に認証を完了してください。',
                    browserTestFailed: 'ブラウザ テストに失敗しました',
                    browserTestFailedHelper:
                        'ID プレビューを完了できませんでした。ローカライズされたバックエンド エラーを確認します。',
                    browserTestIsolation:
                        '実際の認証ラウンドトリップを実行しますが、ユーザーの作成や更新、ロールの割り当て、認証済みパネルセッションの作成は行いません。',
                    browserTestPopupBlocked:
                        'このサイトのポップアップを許可してから、ブラウザ テストを再度開始してください。',
                    browserTestPopupClosed: 'テストが完了する前に認証ウィンドウが閉じられました。',
                    browserTestSuccess: 'プロバイダーの検証に成功しました',
                    browserTestSuccessHelper: 'ユーザーやセッションを変更せずに ID マッピングがプレビューされました。',
                    browserTestTitle: 'OIDC ブラウザー テスト ログイン',
                    browserTestWaiting: 'プロバイダーの認証を待機中',
                    ...
                    configurationHighRiskPassed: '設定は合格しましたが、高リスクの互換性オプションが含まれています。',
                    configurationHighRiskTag: '高リスクの設定は合格しました',
                    configurationNotTested: '現在の設定はテストされていません。',
                    ...
                    configurationTestResult: '構成テスト結果',
                    configurationTestResultDesc:
                        'これは、Discovery と機能のみをチェックします。認証コードを交換したり、Client Secret を証明したりするものではありません。エンドツーエンドの検証にはブラウザのテスト ログインを使用します。',
                    configurationTestSuccess: 'OIDC 構成テストは成功しました。',
                    configurationTesting: '現在の OIDC 構成をテストしています…',
                    configurationTestingTag: 'テスト中',
                    configureSecret: 'Client Secret を設定',
                    conflictExistingRename: 'バインドされた subject が、すでに使用中の新しいユーザー名を返します。',
                    conflictExistingRenameResult:
                        '既存の User.Name を保持し、バインドされたユーザーがサインインできるようにします。',
                    conflictLDAP: 'LDAP ユーザー',
                    conflictLocal: 'ローカル ユーザー',
                    conflictNewAvailable: '新しい subject とマッピングされたユーザー名が利用可能',
                    conflictNewAvailableResult: 'エンタープライズ ユーザーを作成し、デフォルトのロールを割り当てる',
                    conflictNone: '競合なし',
                    conflictOIDC: '別の OIDC ID',
                    conflictOccupied:
                        'マッピングされたユーザー名は、ローカルユーザー、LDAP ユーザー、または別の OIDC ID に属します。',
                    conflictOccupiedResult: '新しいアイデンティティを拒否します。自動的にバインドまたはマージしない',
                    conflictType: '競合タイプ',
                    ...
                    disableConfirm:
                        'OIDC を無効にすると、このソースのユーザーのアクセスが直ちに無効になります。続行しますか?',
                    disableDiscardConfirm:
                        'OIDC の無効化は緊急処置です。ログイン エントリが閉じられるだけで、このソースのユーザーのアクセスは直ちに無効になります。 Client Secret の変更を含む、このページのその他の未保存の変更は破棄されます。続行しますか?',
                    disableTitle: 'OIDC を無効にする',
                    disabled: '無効',
                    discoveryAllowlist: 'Discovery セキュリティ許可リスト',
                    enable: '有効化',
                    enableAfterSave: 'OIDC は保存が成功すると有効になります。',
                    enabled: '有効',
                    ...
                    fixedNoTokenPersistence: 'Token、Claims、および verifier は永続化されません。',
                    fixedSecurityPolicy: '常に適用されます。設定は必要ありません',
                    fixedStateNonce: 'ワンタイム state および nonce',
                    fixedTokenValidation: 'ID Token 署名と Claims 検証',
                    highRiskSaveConfirm:
                        'この有効な設定には、高リスクの互換性オプションが含まれています。隔離された環境にそれらが必要であることを確認します。',
                    highRiskTitle: '高リスク OIDC 構成',
                    hs256Compatibility: 'HS256 (互換性)',
                    hs256KeyHelper: 'HS256 は常にこのソースの Client Secret を使用し、別の署名キーを受け入れません。',
                    hs256Warning:
                        'HS256 は ID Token 署名に共有対称シークレットを使用します。プロバイダーが非対称アルゴリズムを使用できない場合にのみ使用してください。',
                    identityBindingPolicy:
                        'ID は AuthSourceID + issuer + subject に固定されます。ユーザー名が一致しても別のアカウントへ自動的に関連付けません。',
                    identityMissing: 'ID が無効',
                    issuer: 'Issuer URL',
                    issuerHelper: 'ID Token の値と Discovery issuer はこの値と正確に一致する必要があります。',
                    issuerInvalid:
                        'クエリまたはフラグメントを含まない有効な HTTP または HTTPS の Issuer URL を入力してください。',
                    issuerRequired: 'Issuer URL を入力してください。',
                    jwksRotation: 'JWKS の自動回転',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: '署名キーのソースが JWKS の場合、非対称署名に必要です。',
                    jwksURIInvalid: '選択した署名キー ソースに有効な JWKS URI を入力します。',
                    keepExistingRole: '既存のロールとローカル権限を保持します',
                    localSecurityData: 'ローカル セキュリティ データ',
                    localSecurityDataPolicy: 'ロール、MFA、API Keys、Passkeys、ローカル権限は上書きしません。',
                    localCredentialsManaged:
                        'ユーザー名とローカルパスワードは OIDC によって管理されており、ここでは編集できません。ロール、権限、MFA、API Keys、Passkeys はローカルのままです。',
                    localUserFields: 'ローカル ユーザー フィールド',
                    localUserFieldsDesc:
                    ...
                    pkceS256: 'S256 (推奨)',
                    plannedHandling: '計画された処理',
                    privateNetworkIdP: 'プライベート ネットワーク IdP',
                    privateNetworkIdPHelper:
                        'プライベート アドレスを明示的に許可します。メタデータ、ループバック、リンクローカル、リダイレクト、および DNS リバインドはブロックされたままです。',
                    privateNetworkWarning: 'プライベート ネットワーク アクセスは、この認証ソースに対して有効です。',
                    protocolCompatibility: 'プロトコルの互換性',
                    protocolCompatibilityDesc: 'ID Token 署名の検証を無効にすることはできません。',
                    providerAndClient: 'プロバイダーとクライアント',
                    providerAndClientDesc:
                        'Client Secret は置換またはクリアのみ可能で、ページから返されることはありません。',
                    providerCapabilities: 'プロバイダーの機能',
                    recentTestSuccess: '最後のテストは成功しました: {0}',
                    recommended: '推奨',
                    ...
                    restore: '復元',
                    restored: '最後に保存された OIDC 設定が復元されました。',
                    result: '結果',
                    rolesLoadFailed:
                    ...
                    secretPlaceholder: '新しいClient Secretを入力してください',
                    secretReplaceHelper:
                    ...
                    signingAlgorithm: 'ID Token 署名アルゴリズム',
                    signingAlgorithmHelper: 'バックエンド セキュリティ ホワイトリスト内のアルゴリズムのみが有効です。',
                    signingKey: '署名キー',
                    signingKeyClientSecret: 'Client Secret (HS256 のみ)',
                    signingKeyJWKS: '自動ローテーション付きの JWKS URI',
                    signingKeySource: '署名キーのソース',
                    ...
                    standardProtocolPolicyDesc:
                        '署名機能は自動的にネゴシエートされます。ここには署名キーは入力されません。',
                    staticSigningKey: '静的署名公開キー',
                    staticSigningKeyHelper:
                        '公開キー素材のみ使用できます。プロバイダーのキーが変更された場合は手動でローテーションしてください。',
                    staticSigningKeyPlaceholder: 'JWK、JWKS JSON、または PEM 公開キーを貼り付けます。',
                    staticSigningKeyRequired: '静的署名公開キーを指定します。',
                    staticSigningKeyWarning:
                        '静的署名キーは自動的にローテーションできません。プロバイダーがキーをローテーションする前に更新してください。',
                    settingLoadFailed: 'OIDC 設定を読み込めませんでした。',
                    settingLoadFailedHelper:
                        '現在の設定に空のデフォルト設定が保存されないように、フォームはロックされています。接続が回復してから再試行してください。',
                    subsequentLogin: 'その後のログイン',
                    ...
                    tlsPrivateHTTP: 'HTTP · プライベート ネットワークのみ (危険)',
                    ...
                    transportSecurity: 'トランスポート セキュリティ',
                ...
                saml2: {
                    ...
                    actionPending: '結果を待機中',
                    actionReject: 'ログインの拒否',
                    actionReuse: '紐付け済みユーザーを使用',
                    assignDefaultRole: 'デフォルトのロールの割り当て: {role}',
                    basic: '基本設定',
                    basicDesc: '標準的な SAML2 IdP に必要な一般設定を構成します。',
                    browserTest: 'ログインテスト',
                    browserTestConflict: 'ID は確認されましたが、ユーザー名が競合しています。',
                    browserTestConflictHelper:
                        'マッピングされたユーザー名は別の ID に属するため、自動的に関連付けません。',
                    ...
                    browserTestSuccess: 'プロバイダーの検証に成功しました',
                    browserTestSuccessHelper: 'ユーザーやセッションを変更せずに ID マッピングがプレビューされました。',
                    browserTestTitle: 'SAML2 ブラウザー テスト ログイン',
                    browserTestWaiting: 'プロバイダーの認証を待機中',
                    browserTestWaitingHelper:
                        '新しいブラウザウィンドウでログインを完了してください。このページは自動的に更新されます。',
                    certificateFileInvalid: '有効な PEM、CRT、または CER 証明書ファイルを選択してください。',
                    configured: '設定済み',
                    configurationFailedHelper:
                        'テストは失敗しました。このページには、ローカライズされたバックエンド エラーのみが表示されます。',
                    configurationNotTested: '現在の設定はテストされていません。',
                    ...
                    configurationTestSuccess: 'SAML2 構成テストは成功しました。',
                    configurationTesting: '現在の SAML2 構成をテストしています…',
                    conflictLDAP: 'LDAP ユーザー',
                    conflictLocal: 'ローカル ユーザー',
                    conflictNone: '競合なし',
                    conflictOIDC: '別の OIDC ID',
                    conflictSAML2: '別の SAML2 ID',
                    conflictType: '競合タイプ',
                    credentialFileReadFailed: '認証情報ファイルを読み取れませんでした。',
                    credentialFileTooLarge: '認証情報ファイルは 256 KiB 以下にしてください。',
                    credentialsRequired: 'SP 秘密鍵と証明書の両方を設定してください。',
                    defaultRole: '新規ユーザーのロール',
                    defaultRoleHelper:
                        '初回作成時のみ割り当てます。以後のログインではローカルのロール、MFA、権限を保持します。',
                    defaultRolePlaceholder: 'ロールを選択してください。',
                    defaultRoleRequired: '有効なデフォルトのロールを選択してください。',
                    disableConfirm:
                        'SAML2 を無効にすると、新規ログインが直ちに拒否され、そのユーザーセッションが無効になります。続行しますか？',
                    disableDiscardConfirm:
                        'SAML2 を無効にすると、このページの他の未保存の変更が破棄され、ユーザーセッションが直ちに無効になります。続行しますか？',
                    disableTitle: 'SAML2 を無効にする',
                    disabled: '無効',
                    enable: '有効化',
                    enabled: '有効',
                    idpMetadata: 'IdP メタデータ',
                    idpMetadataDesc: 'URL または XML のいずれかを入力します。両方ある場合は URL が優先されます。',
                    keepExistingRole: '既存のロールとローカル権限を保持します',
                    loginWith: '{provider} でログイン',
                    mappingResult: 'マッピング結果',
                    metadataRequired: 'IdP Metadata URL または XML を入力してください。',
                    metadataURLHelper: 'テスト時と保存時に、バックエンドがメタデータを取得して検証します。',
                    metadataURLInvalid:
                        '認証情報やフラグメントを含まない有効な HTTPS メタデータ URL を入力してください。',
                    metadataURLRecommended: 'メタデータ URL（推奨）',
                    metadataXML: 'メタデータ XML',
                    metadataXMLHelper: 'IdP が到達可能なメタデータ URL を公開していない場合に使用します。',
                    metadataXMLInvalid: '有効な EntityDescriptor メタデータ XML を入力してください。',
                    ...
                    notConfigured: '未設定',
                    or: 'または',
                    pageDesc: 'IdP Metadata を使用して企業 SSO を接続し、一般設定を 1 ページで完了します。',
                    plannedHandling: '計画された処理',
                    privateKeyFileInvalid: '有効な PEM 秘密鍵ファイルを選択してください。',
                    recentTestSuccess: '最後のテストは成功しました: {0}',
                    restore: '復元',
                    restored: '最後に保存された SAML2 設定が復元されました。',
                    roleHandling: 'ロール処理',
                    rolesLoadFailed:
                        'ロールをロードできませんでした。デフォルトのロールを選択する前に再試行してください。',
                    selectFile: 'ファイルを選択',
                    serviceStatus: 'サービス状態',
                    serviceStatusDesc: 'SAML2 を有効にするには、現在の設定がテストに合格する必要があります。',
                    settingLoadFailed: 'SAML2 設定を読み込めませんでした。',
                    settingLoadFailedHelper:
                        '現在の設定に空のデフォルト設定が保存されないように、フォームはロックされています。接続が回復してから再試行してください。',
                    spCertificate: 'SP 証明書',
                    spCertificateHelper:
                        'IdP がログインおよびログアウト要求を検証できるように、SP メタデータで公開されます。',
        ...
        node: {
            ...
            dashboardSetting: '概要設定',
            keepOneDashboardComponent: '概要セクションを少なくとも 1 つ残してください',
        },
        customApp: {
            name: 'カスタムアプリリポジトリ',
        ...
        alert: {
            ...
            avgRule: '{0} 分以内の平均 {1} 使用率が {2}% を超えるとアラートを発生させ、1日 {3} 回送信します',
        ...
        vm: {
            ...
            disk: 'ディスク',
            overview: '概要',
            kvmUnavailable: '利用可能な KVM ハードウェア仮想化機能が検出されませんでした。',
            kvmCheckCpu: 'ホスト CPU が Intel VT-x または AMD-V をサポートしていることを確認してください。',
            kvmCheckBios: 'BIOS/UEFI で仮想化オプションを有効にしてください。',
            kvmCheckModule:
                'kvm、kvm_intel、kvm_amd カーネルモジュールが正しく読み込まれていることを確認してください。',
            kvmCheckDevice:
                '/dev/kvm が存在し、現在の環境が KVM 非対応のコンテナまたはクラウドホストではないことを確認してください。',
            abnormal: '異常',
            resourceOverview: 'リソース概要',
            cpuAllocated: 'CPU 割り当て',
            memoryAllocated: 'メモリ割り当て',
            storageUsed: '使用済みストレージ',
            riskReminder: 'リスク通知',
            noRisk: 'リスクなし',
            runtimeHealth: '実行環境の状態',
            runtimeAbnormal: 'VM 実行環境に異常があります',
            noDependency: '依存関係のチェックデータがありません',
            storageOverview: 'ストレージ概要',
            totalAllocated: 'VM の合計構成から算出',
            runningAllocated: '実行中の割り当て：{0}',
            storageAvailable: '利用可能：{0}',
            inProgress: '処理中',
            needAttention: '要確認',
            normal: '正常',
            environmentRisk: 'VM 実行環境の準備ができていません。依存関係または仮想化サービスを修正してください。',
            storageRisk: 'ストレージプール {0} の使用率が {1}% に達しました。',
            abnormalRisk: '{0} 台の VM が異常な状態です。',
            pausedRisk: '{0} 台の VM が一時停止中です。',
            memoryRisk: 'VM のメモリ割り当て率が {0}% に達しました。',
            ...
            convertToTemplate: 'テンプレートに変換',
            sourceVM: '元の VM',
            templateSize: 'テンプレートサイズ',
            ...
            monitorLoadFailedWithReason: 'VM の監視データを取得できませんでした：{0}',
            rename: '名前変更',
            newName: '新しい名前',
            renameHelper: '新しい VM 名を入力してください。名前を変更する前に VM を停止する必要があります。',
            renameConfirm: '仮想マシン [{0}] の名前を [{1}] に変更しますか？',
            renameRunningHelper: '名前を変更する前に仮想マシンを停止してください。',
            cpuUsage: 'CPU 使用率',
            memoryUsage: 'メモリ使用率',
            diskIO: 'ディスク I/O',
            networkIO: 'ネットワーク I/O',
            diskReadWrite: 'ディスク読み取り/書き込み',
            networkRxTx: 'ネットワーク受信/送信',
            rx: 'RX',
            tx: 'TX',
            console: 'コンソール',
            ...
            recoverSnapshot: 'スナップショットを復元',
            snapshotSize: '使用量',
            currentSnapshot: '現在',
            snapshotEmpty: 'スナップショットがありません',
            snapshotHelper:
                'スナップショットは現在の VM 状態を復元ポイントとして保存します。以降のデータ変更は元のディスクを変更せず差分ファイルに記録されます。復元すると VM はその時点の状態に戻ります。',
            snapshotOperationHelper:
                '現在のスナップショットは削除できません。スナップショットを復元できるのは仮想マシンが停止している場合のみです。',
            snapshotRecoverConfirm:
                '仮想マシン [{1}] をスナップショット [{0}] に復元しますか？VM ディスクはスナップショット時点の状態に戻ります。',
