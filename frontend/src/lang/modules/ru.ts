...
const message = {
    commons: {
        ...
        rule: {
            ...
            nginxDoc: 'Это поле должно состоять из английских букв, цифр, ".", "_" и "-".',
            appName:
            ...
            vmName: 'Допустимы латинские буквы, цифры, ".", "-" и "_"; длина: 1-64; значение должно начинаться с буквы или цифры.',
            vmNetwork:
                'Допустимы латинские буквы, цифры, ".", ":", "-" и "_"; длина: 1-64; значение должно начинаться с буквы или цифры.',
        },
        res: {
    ...
    home: {
        ...
        loadAverage: 'Средняя нагрузка за последние {0} мин.',
        load: 'Нагрузка',
    ...
    database: {
        ...
        deleteUserHelper: '" для удаления этого пользователя',
        ...
        supplementPasswordHelper: 'Сохраняет текущий пароль только в NexaCP и не изменяет пароль в MySQL.',
        noUserBind: 'Нет привязки',
        pgBindHelper:
        ...
        loadFromRemoteHelper: 'Синхронизировать базы данных, пользователей и права доступа с сервера в NexaCP?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Эта модель не была загружена через NexaCP, нет связанных журналов извлечения.',
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Сохранить текущий срок',
            neverExpires: 'Без срока действия',
            validForDays: 'Действителен {0} дней',
            customDays: 'Указать дни',
            enterValidityDays: 'Введите срок действия в днях',
            currentExpiresAt: 'Текущий срок действия: {0}',
            currentNeverExpires: 'Срок действия не ограничен',
            expiresAt: 'Истекает',
            expired: 'Истёк',
            ...
            protocolConversionRisk:
                'Преобразование протоколов не гарантирует отсутствие потерь. Специфичные поля, вызовы инструментов, рассуждения или мультимодальные данные могут быть упрощены или потеряны. Используйте после оценки рисков.',
            visionEnhancement: 'Визуальное расширение',
            visionEnhancementRisk: 'Изображения могут отправляться отдельному поставщику визуальной модели.',
            visionModelGroup: 'Группа визуальных моделей',
            visionModelGroupDesc:
                'Выберите модель с поддержкой изображений из этой группы генерации текста. Все изображения запроса используют одну модель.',
            visionTargetModelGroup: 'Целевая группа моделей',
            visionTargetModelGroupDesc:
                'Включает расширение только для моделей этой группы, не изменяя итоговую модель запроса.',
            visionEnhancementDesc:
                'Изображения преобразуются в текст и могут потерять детали, увеличивая задержку и стоимость. Шлюз не определяет встроенную поддержку изображений. Сохранение перезапускает шлюз; используйте после оценки рисков.',
            visionPreprocess: 'Визуальная предобработка',
            ...
            autoRefreshSeconds: 'Автообновление каждые {0} сек.',
            zeroMeansUnlimited: 'Укажите 0 для отсутствия ограничений.',
            groupMaxConcurrencyDesc: 'Ограничивает активные запросы всех API Key группы. 0 означает без ограничений.',
            apiKeyMaxConcurrencyDesc:
                'Ограничивает активные запросы каждого API Key группы. 0 означает без ограничений.',
            schedulingReason: 'Причина планирования',
            schedulingAffinity: 'Привязка',
            schedulingLeastUtilized: 'Наименьшая загрузка',
            schedulingPriorityFallback: 'Понижение приоритета',
            schedulingRetry: 'Повторная попытка',
            ...
            upstreamDuration: 'Время upstream',
            ...
            contentCompliance: 'Соответствие содержимого',
            contentAction: 'Действие',
            actionBlock: 'Блокировать',
            actionAuditOnly: 'Только аудит',
            actionDropHistory: 'Удалить историю',
            severity: 'Серьёзность',
            severityHigh: 'Высокая',
            severityMedium: 'Средняя',
            severityLow: 'Низкая',
            sensitiveWord: 'Чувствительное слово',
            sensitiveGroup: 'Группа чувствительных слов',
            sensitiveWordCount: 'Слова',
            normalizedWord: 'Нормализованное слово',
            matchedWords: 'Совпавшие слова',
            matchedGroups: 'Совпавшие группы',
            importResult: 'Импортировано: {0}, дубликатов: {1}, недействительных: {2}',
        ...
        mcp: {
            ...
            protocolVersionHelper:
                'Используется только Streamable HTTP без состояния для автоматической инициализации нижестоящего stdio MCP Server',
            gatewayArgsHelper:
                'Аргументы добавляются к команде supergateway. Параметры транспорта, порта, пути и протокола, управляемые NexaCP, изменить нельзя',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Обнаружено, что контейнер создан из Магазина приложений. Удаление контейнера не удалит его полностью из NexaCP. Для полного удаления перейдите в Магазин приложений -> меню 'Установленные' или 'Среда выполнения'. Продолжить?",
        start: 'Запустить',
        stop: 'Остановить',
        restart: 'Перезапустить',
        kill: 'Завершить',
        ...
        cleanLogscope: 'Тип очистки',
        downLogHelper1: 'Это загрузит все логи из контейнера {0}. Хотите продолжить?',
        downLogHelper2: 'Это загрузит последние {1} записей журнала из контейнера {0}. Продолжить?',
        ...
        composeHelper:
            'Композиция, созданная через редактор NexaCP или шаблон, будет сохранена в директории {0}/docker/compose.',
        ...
        composeDetailHelper: 'Compose создан вне NexaCP. Операции запуска и остановки не поддерживаются.',
        ...
        composeEnvHelper2:
            'Эта оркестрация создана Магазином приложений NexaCP. Измените переменные среды в установленных приложениях.',
        ...
        mirrorsHelper:
            'Сначала используйте URL зеркал реестра для операций с образами. Оставьте поле пустым, чтобы отключить зеркала реестра.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Ротированные файлы логов будут сохранены в директории резервных копий NexaCP.',
        ...
        logHelper1: '1. Системный лог NexaCP',
    ...
    logs: {
        ...
        detail: {
            ...
            ops_report: 'Операционный отчет',
            users: 'Управление пользователями',
            roles: 'Роль',
            auth: 'Аутентификация входа',
            auth_sources: 'Настройки аутентификации',
    ...
    file: {
        ...
        shareExpire: 'Срок действия',
        shareExpire1h: '1 час',
        shareExpire6h: '6 часов',
        shareExpire24h: '24 часа',
        shareExpire3d: '3 дня',
        shareExpire7d: '7 дней',
        sharePassword: 'Пароль',
        sharePasswordPlaceholder: 'Оставьте пустым, чтобы не использовать пароль',
        shareMaxDownloads: 'Максимум загрузок',
        shareMaxDownloadsHint: '0 означает без ограничений',
        shareGenerate: 'Создать ссылку',
        shareRegenerate: 'Поделиться снова',
        shareClose: 'Закрыть',
        shareCancel: 'Отменить общий доступ',
        shareCancelConfirm: 'Вы уверены, что хотите отменить общий доступ к этому файлу?',
        shareDetail: 'Сведения',
        shareCopyLink: 'Копировать ссылку',
        shareLinkLabel: 'Ссылка общего доступа',
        shareQrCode: 'QR-код',
        shareQrDialogTitle: 'QR-код ссылки общего доступа',
        shareQrDialogHelper: 'Отсканируйте QR-код с мобильного устройства',
        shareSaveImage: 'Сохранить изображение',
        shareOpenImage: 'Открыть изображение',
        shareExtractFile: 'Получить файл',
        shareDownloadingHint: 'Файл подготавливается. Загрузка скоро начнётся.',
        shareInvalid: 'Недействительная или просроченная ссылка общего доступа',
        shareDownloadFailed: 'Не удалось загрузить файл. Повторите попытку позже',
        sharePasswordRequired: 'Пароль доступа',
        sharePasswordRequiredInput: 'Введите пароль общего доступа',
        sharePasswordLengthHint: 'Длина пароля общего доступа должна составлять 4–256 символов',
        shareDownloadPasswordTip: 'Эта ссылка защищена паролем. Введите пароль перед загрузкой.',
        shareRiskAlert:
            'Ссылки общего доступа могут представлять угрозу безопасности. Делитесь ими только с доверенными людьми и не раскрывайте конфиденциальные данные.',
        sharePasswordSeparate:
            'Пароль задан. Передайте его безопасным способом. Получатель должен добавить &password=... к URL или использовать клиент, поддерживающий параметр пароля.',
        ...
        panelInstallDir: 'Директорию установки NexaCP нельзя удалить',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Изменение часового пояса зависит от системной службы timedatectl. Вступит в силу после перезапуска службы NexaCP.',
        timeZoneCN: 'Пекин',
        timeZoneAM: 'Лос-Анджелес',
        timeZoneNY: 'Нью-Йорк',
        ntpALi: 'Alibaba',
        ...
        codeHelper:
            'Нажмите кнопку «Получить», затем войдите в {0} и скопируйте содержимое после «code» в перенаправленной ссылке. Вставьте его в это поле. Подробные инструкции смотрите в официальной документации.',
        googleHelper:
        ...
        passkeyPrereqBindDomain: 'Настроена привязка домена NexaCP',
        ...
        bindDomainHelper: 'После привязки домена только этот домен сможет получить доступ к службе NexaCP.',
        bindDomainHelper1: 'Оставьте пустым, чтобы отключить привязку доменного имени.',
        bindDomainWarning:
            'После привязки домена вы будете выходить из системы и сможете получить доступ к службе NexaCP только через указанное в настройках доменное имя. Хотите продолжить?',
        ...
        mfaTitleHelper:
            'Заголовок используется для различения разных хостов NexaCP. Отсканируйте снова или вручную добавьте секретный ключ после изменения заголовка.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Это правило будет использоваться для сжатия и резервного копирования директории данных NexaCP при создании снапшота. По умолчанию игнорируются файлы сокетов.',
        ignoreHelper1: 'По одному в строке. Например,\n*.log\n/opt/1panel/cache',
        panelInfo: 'Записать базовую информацию NexaCP',
        panelBin: 'Резервное копирование системных файлов NexaCP',
        daemonJson: 'Резервное копирование конфигурационного файла Docker',
        appData: 'Резервное копирование установленных приложений из NexaCP',
        panelData: 'Резервное копирование директории данных NexaCP',
        backupData: 'Резервное копирование локальной директории резервных копий для NexaCP',
        ...
        recoverHelper1: 'Восстановление требует перезапуска служб Docker и NexaCP',
        recoverHelper2:
        ...
        rollback: 'Откатить',
        rollbackHelper:
            'Откат этого восстановления заменит все файлы из этого восстановления и может потребовать перезапуска служб Docker и NexaCP. Хотите продолжить?',
        upgradeHelper: 'Обновление требует перезапуска службы NexaCP. Хотите продолжить?',
        rollbackLocalHelper:
    ...
    license: {
        ...
        securityWarningContent:
            'NexaCP должен запускаться пользователем с правами системного администратора. Неофициальные лицензии или измененные сборки могут привести к потере контроля над сервером, утечке данных и другим серьезным рискам безопасности. Получайте лицензии и установочные пакеты только через официальные каналы FIT2CLOUD.',
        ...
        node: 'Обновление до коммерческой редакции позволяет управлять несколькими серверами Linux с помощью NexaCP.',
        nodeApp:
        ...
        vllm: 'Обновите до коммерческой версии, чтобы централизованно управлять сервисами vLLM в NexaCP: развертыванием, настройкой, жизненным циклом и отслеживанием задач.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Легко очищайте мусорные файлы, созданные во время работы NexaCP',
        ...
        unknownWebsiteLog: 'Несвязанный файл резервной копии журнала сайта',
    ...
    website: {
        ...
        runtimePortHelper: 'Текущая среда выполнения предоставляет несколько портов. Выберите порт прокси.',
    ...
    ssl: {
        ...
        shellHelper:
            'Директория выполнения скрипта по умолчанию - директория установки NexaCP. Если сертификат отправляется в локальную директорию, директорией выполнения будет директория отправки сертификата. Тайм-аут выполнения по умолчанию - 30 минут.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Это изменит значение "files" в секции "[include"] в основном конфигурационном файле. Директория других конфигурационных файлов будет: "{директория установки NexaCP}/1panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                reportNode: 'Узел отчёта',
                selectReportNode: 'Выберите узел отчёта',
                currentNode: 'Текущий',
                scoreMeta: 'Снято {0} баллов · рисков: {1}',
                hostAddress: 'Адрес узла',
                panelVersion: 'Версия панели',
                cpuCores: 'Физические ядра',
                coreUnit: '{0} ядер',
                memoryTotal: 'Общий объём памяти',
                ...
                scoreSSLExpired: '{0} — срок действия сертификата истёк',
                scoreSSLHigh: '{0} — сертификат истекает через {1} дней',
                scoreSSLMedium: '{0} — сертификат истекает через {1} дней',
                scoreWebsiteExpired: '{0} — срок действия сайта истёк',
                ...
                serviceEnabledButAbnormal: 'Включено, но состояние ненормальное',
                ...
                disabledCronjobTasks: 'Отключённые плановые задачи',
        ...
        user: {
            ...
            auth: {
                ...
                defaultNode: 'Узел по умолчанию',
                defaultNodePlaceholder: 'Выберите узел',
                defaultNodeHelper: 'Только для новых пользователей.',
                defaultNodeRequired: 'Выберите допустимый узел по умолчанию.',
                nodesLoadFailed: 'Не удалось загрузить узлы. Повторите попытку перед выбором узла по умолчанию.',
                nodeHandling: 'Обработка узла',
                assignDefaultNode: 'Назначить узел по умолчанию: {node}',
                keepExistingNode: 'Сохранить существующие разрешения узла',
                providers: {
                    ldap: 'AD/LDAP',
                    passkey: 'Passkey',
                    radius: 'Radius',
                ...
                oidc: {
                    accessMode: 'Режим подключения',
                    accessModeDesc: 'Используйте стандарт Discovery, если поставщик удостоверений поддерживает его.',
                    actionCreate: 'Создать пользователя',
                    actionKeepName: 'Сохранить текущее имя пользователя',
                    actionPending: 'Ожидание результата',
                    actionReject: 'Отклонить вход',
                    actionUpdate: 'Обновить идентификационную информацию',
                    advanced: 'Расширенные настройки',
                    advancedDesc:
                        'Сохраняйте безопасные настройки по умолчанию, если поставщик не требует опции совместимости.',
                    assignDefaultRole: 'Назначить роль по умолчанию: {role}.',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Введите действительный Authorization Endpoint.',
                    authorizationFlow: 'Процесс авторизации',
                    automatic: 'Автоматический',
                    automaticPolicy: 'Политика автоматической обработки',
                    automaticPolicyDesc:
                        'Эти правила применяются серверной частью и не являются переключателями администратора.',
                    basic: 'Основные настройки',
                    basicDesc: 'Выберите режим провайдера, затем настройте клиент и обратный вызов.',
                    browserTest: 'Тестовый вход в браузере',
                    browserTestConflict: 'Личность подтверждена, но имя пользователя уже занято.',
                    browserTestConflictHelper:
                        'Сопоставленное имя пользователя принадлежит другой идентичности и не будет присвоено.',
                    browserTestExpired: 'Срок проверки браузера истек',
                    browserTestExpiredHelper:
                        'Запустите новый тест браузера и завершите авторизацию до истечения срока его действия.',
                    browserTestFailed: 'Проверка браузера не удалась',
                    browserTestFailedHelper:
                        'Не удалось выполнить предварительный просмотр личности. Просмотрите локализованную серверную ошибку.',
                    browserTestIsolation:
                        'Выполняется полный цикл реальной авторизации, но пользователи не создаются и не обновляются, роли не назначаются и аутентифицированный сеанс панели не создаётся.',
                    browserTestPopupBlocked:
                        'Разрешите всплывающие окна для этого сайта, затем снова запустите проверку браузера.',
                    browserTestPopupClosed: 'Окно авторизации было закрыто до завершения теста.',
                    browserTestSuccess: 'Проверка Provider прошла успешно',
                    browserTestSuccessHelper:
                        'Сопоставление удостоверений было предварительно просмотрено без изменения пользователей или сеансов.',
                    browserTestTitle: 'OIDC тестовый вход в браузер',
                    browserTestWaiting: 'Ожидание авторизации Provider',
                    ...
                    clockSkewHelper:
                        'Допускает небольшую разницу времени между поставщиком удостоверений и NexaCP. Оставьте значение по умолчанию 60 секунд.',
                    ...
                    configurationHighRiskPassed:
                        'Конфигурация прошла успешно, но содержит параметры совместимости с высоким уровнем риска.',
                    configurationHighRiskTag: 'Конфигурация высокого риска пройдена',
                    configurationNotTested: 'Текущая конфигурация не тестировалась.',
                    ...
                    configurationTestResult: 'Результат теста конфигурации',
                    configurationTestResultDesc:
                        'При этом проверяется только Discovery и его возможности; он не обменивает код авторизации и не подтверждает Client Secret. Используйте тестовый вход в браузер для сквозной проверки.',
                    configurationTestSuccess: 'Тест конфигурации OIDC пройден успешно.',
                    configurationTesting: 'Тестирование текущей конфигурации OIDC…',
                    configurationTestingTag: 'Тестирование',
                    configureSecret: 'Настроить секрет',
                    conflictExistingRename: 'Связанный subject возвращает новый name, который занят.',
                    conflictExistingRenameResult:
                        'Сохраните существующий User.Name и разрешите связанному пользователю войти в систему.',
                    conflictLDAP: 'Пользователь LDAP',
                    conflictLocal: 'Локальный пользователь',
                    conflictNewAvailable: 'Доступны новый subject и сопоставленный name.',
                    conflictNewAvailableResult: 'Создайте корпоративного пользователя и назначьте роль по умолчанию.',
                    conflictNone: 'Нет конфликта',
                    conflictOIDC: 'Еще одна личность OIDC',
                    conflictOccupied:
                        'Сопоставленный name принадлежит локальному LDAP или другому идентификатору OIDC.',
                    conflictOccupiedResult:
                        'Отклонить новую личность; никогда не связывать и не объединять автоматически',
                    conflictType: 'Тип конфликта',
                    connectionSecurity: 'Безопасность соединения',
                    ...
                    customCAHelper:
                        'Применяется только к этому источнику аутентификации и никогда не записывается в журналы.',
                    ...
                    disableConfirm:
                        'Отключение OIDC немедленно аннулирует доступ пользователей этого источника. Продолжать?',
                    disableDiscardConfirm:
                        'Отключение OIDC является экстренным действием: оно лишь закрывает вход в систему и немедленно аннулирует доступ для пользователей этого источника. Другие несохраненные изменения на этой странице, включая изменения Client Secret, будут отменены. Продолжать?',
                    disableTitle: 'Отключить OIDC',
                    disabled: 'Отключено',
                    discoveryAllowlist: 'Discovery ∩ список разрешений безопасности',
                    enable: 'Включить',
                    enableAfterSave: 'OIDC будет включен после успешного сохранения.',
                    enabled: 'Включено',
                    ...
                    fixedNoTokenPersistence: 'Token, Claims и verifier никогда не сохраняются.',
                    fixedSecurityPolicy: 'Всегда соблюдается; не требуется настройка',
                    fixedStateNonce: 'Одноразовые state и nonce',
                    fixedTokenValidation: 'Подпись ID Token и проверка Claims',
                    highRiskSaveConfirm:
                        'Эта включенная конфигурация содержит параметры совместимости с высоким уровнем риска. Убедитесь, что они требуются для изолированной среды.',
                    highRiskTitle: 'Конфигурация OIDC высокого риска',
                    hs256Compatibility: 'HS256 (совместимость)',
                    hs256KeyHelper:
                        'HS256 всегда использует Client Secret этого источника и не принимает отдельный ключ подписи.',
                    hs256Warning:
                        'HS256 использует общий симметричный секрет для подписей ID Token. Используйте его только в том случае, если Provider не ​​может использовать асимметричный алгоритм.',
                    identityBindingPolicy:
                        'Идентичность фиксируется по AuthSourceID + issuer + subject. Совпадение имени пользователя никогда не приводит к привязке другой учетной записи.',
                    identityMissing: 'Идентификатор неактивен',
                    issuer: 'Issuer URL',
                    issuerHelper:
                        'Значение iss ID Token и Discovery issuer должны точно соответствовать этому значению.',
                    issuerInvalid: 'Введите действительный HTTP или HTTPS Issuer URL без запроса или фрагмента.',
                    issuerRequired: 'Введите Issuer URL.',
                    jwksRotation: 'Автоматическое вращение JWKS',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Требуется для асимметричной подписи, когда источником ключа является JWKS.',
                    jwksURIInvalid: 'Введите действительный JWKS URI для выбранного источника ключа подписи.',
                    keepExistingRole: 'Сохраните существующие роли и локальные разрешения.',
                    localSecurityData: 'Данные локальной безопасности',
                    localSecurityDataPolicy:
                        'Никогда не перезаписывайте роли, MFA, API Keys, Passkeys или локальные разрешения.',
                    localCredentialsManaged:
                        'Имя пользователя и локальный пароль управляются OIDC и не могут быть изменены здесь. Роли, разрешения, MFA, API Keys и Passkeys остаются локальными.',
                    localUserFields: 'Поля локального пользователя',
                    localUserFieldsDesc:
                    ...
                    panelURL: 'NexaCP общедоступный URL',
                    panelURLHTTPWarning:
                        'HTTP не ​​защищает ответ авторизации. Используйте его только в изолированной частной среде, разрешенной Provider.',
                    panelURLHelper:
                        'Укажите адрес, по которому пользователи открывают NexaCP. Он используется для формирования URL обратного вызова.',
                    panelURLInvalid: 'Введите источник, содержащий только схему, хост и дополнительный порт.',
                    panelURLRequired: 'Введите общедоступный NexaCP URL.',
                    pkceDisabled: 'Отключено (только совместимость)',
                    pkceDisabledWarning: 'Отключение PKCE снижает защиту от перехвата кода авторизации.',
                    pkceHelper: 'Предпочитаю S256. Метод вызова plain никогда не предлагается.',
                    pkceS256: 'S256 (рекомендуется)',
                    plannedHandling: 'Плановая обработка',
                    privateNetworkIdP: 'IdP частной сети',
                    privateNetworkIdPHelper:
                        'Явно разрешает частные адреса; метаданные, петля, локальная ссылка, перенаправление и повторное связывание DNS остаются заблокированными.',
                    privateNetworkWarning: 'Для этого источника аутентификации включен доступ к частной сети.',
                    protocolCompatibility: 'Совместимость протоколов',
                    protocolCompatibilityDesc: 'Проверка подписи ID Token никогда не может быть отключена.',
                    providerAndClient: 'Provider и клиент',
                    providerAndClientDesc:
                        'Client Secret можно только заменить или очистить, и страница никогда не возвращает его.',
                    providerCapabilities: 'Возможности Provider',
                    recentTestSuccess: 'Последний тест прошел успешно: {0}',
                    recommended: 'Рекомендуется',
                    rejectPlain: 'plain отклонен',
                    ...
                    restored: 'Были восстановлены последние сохраненные настройки OIDC.',
                    result: 'Результат',
                    rolesLoadFailed:
                    ...
                    seconds: 'секунды',
                    secretClearHelper:
                        'После очистки потребуется новый Client Secret, прежде чем OIDC можно будет снова включить.',
                    secretConfigured: 'Настроен',
                    secretNotConfigured: 'Не настроено',
                    secretPlaceholder: 'Введите новый Client Secret',
                    secretReplaceHelper:
                        'При сохранении новый секрет заменит прежнее значение. Также обновите Client Secret у OIDC-провайдера.',
                    ...
                    signingAlgorithm: 'Алгоритм подписи ID Token',
                    signingAlgorithmHelper: 'Доступны только алгоритмы из белого списка внутренней безопасности.',
                    signingKey: 'Ключ подписи',
                    signingKeyClientSecret: 'Client Secret (только HS256)',
                    signingKeyJWKS: 'JWKS URI с автоматической ротацией',
                    signingKeySource: 'Источник ключа подписи',
                    signingKeySourceHelper:
                        'Предпочтительно использовать JWKS. Статический открытый ключ нельзя ротировать автоматически.',
                    signingKeyStatic: 'Статический открытый ключ JWK или PEM.',
                    standardDiscovery: 'Стандартный OIDC Discovery',
                    standardDiscoveryDesc:
                        'NexaCP обнаруживает конечные точки и возможности и не сохраняет необработанный документ.',
                    ...
                    standardProtocolPolicyDesc:
                        'Возможности подписи согласовываются автоматически; ключ подписи здесь не введен.',
                    staticSigningKey: 'Статический открытый ключ подписи',
                    staticSigningKeyHelper:
                        'Принимается только материал открытого ключа. Выполните ротацию вручную при изменении ключа Provider.',
                    staticSigningKeyPlaceholder: 'Вставьте открытый ключ JWK, JWKS JSON или PEM.',
                    staticSigningKeyRequired: 'Предоставьте статический открытый ключ подписи.',
                    staticSigningKeyWarning:
                        'Статический ключ подписи нельзя ротировать автоматически; обновите его до ротации ключей Provider.',
                    settingLoadFailed: 'Не удалось загрузить настройки OIDC.',
                    settingLoadFailedHelper:
                        'Форма заблокирована, чтобы избежать сохранения пустой конфигурации по умолчанию поверх текущих настроек. Повторите попытку после восстановления соединения.',
                    subsequentLogin: 'Последующий вход',
                    ...
                    tlsPrivateHTTP: 'HTTP · Только частная сеть (опасно)',
                    ...
                    transportSecurity: 'Транспортная безопасность',
                    ...
                    userMappingDesc:
                        'Настройте сопоставление имени пользователя OIDC, а также узел и роль по умолчанию для создания пользователя при первом входе.',
                },
                saml2: {
                    actionCreate: 'Создать пользователя',
                    actionPending: 'Ожидание результата',
                    actionReject: 'Отклонить вход',
                    actionReuse: 'Использовать привязанного пользователя',
                    assignDefaultRole: 'Назначить роль по умолчанию: {role}.',
                    basic: 'Основные настройки',
                    basicDesc: 'Настройте параметры, необходимые большинству стандартных поставщиков SAML2.',
                    browserTest: 'Проверить вход',
                    browserTestConflict: 'Личность подтверждена, но имя пользователя уже занято.',
                    browserTestConflictHelper:
                        'Сопоставленное имя пользователя принадлежит другой идентичности и не будет присвоено.',
                    browserTestExpired: 'Срок проверки браузера истек',
                    ...
                    browserTestSuccessHelper:
                        'Сопоставление удостоверений было предварительно просмотрено без изменения пользователей или сеансов.',
                    browserTestTitle: 'SAML2 тестовый вход в браузер',
                    browserTestWaiting: 'Ожидание авторизации Provider',
                    browserTestWaitingHelper:
                        'Завершите вход в новом окне браузера. Эта страница будет обновляться автоматически.',
                    certificateFileInvalid: 'Выберите корректный файл сертификата PEM, CRT или CER.',
                    configured: 'Настроено',
                    configurationFailedHelper:
                        'Тест провалился. На странице отображается только локализованная серверная ошибка.',
                    configurationNotTested: 'Текущая конфигурация не тестировалась.',
                    ...
                    configurationTestSuccess: 'Тест конфигурации SAML2 пройден успешно.',
                    configurationTesting: 'Тестирование текущей конфигурации SAML2…',
                    conflictLDAP: 'Пользователь LDAP',
                    conflictLocal: 'Локальный пользователь',
                    conflictNone: 'Нет конфликта',
                    conflictOIDC: 'Еще одна личность OIDC',
                    conflictSAML2: 'Другая учетная запись SAML2',
                    conflictType: 'Тип конфликта',
                    credentialFileReadFailed: 'Не удалось прочитать файл учетных данных.',
                    credentialFileTooLarge: 'Размер файлов учетных данных не должен превышать 256 КиБ.',
                    credentialsRequired: 'Настройте закрытый ключ и сертификат SP.',
                    defaultRole: 'Роль нового пользователя',
                    defaultRoleHelper:
                        'Назначается только при первом создании; последующие входы сохраняют локальные роли, MFA и права.',
                    defaultRolePlaceholder: 'Выберите роль',
                    defaultRoleRequired: 'Выберите допустимую роль по умолчанию.',
                    disableConfirm:
                        'Отключение SAML2 немедленно отклоняет новые входы и аннулирует пользовательские сеансы. Продолжить?',
                    disableDiscardConfirm:
                        'Отключение SAML2 отменяет другие несохраненные изменения на этой странице и немедленно аннулирует пользовательские сеансы. Продолжить?',
                    disableTitle: 'Отключить SAML2',
                    disabled: 'Отключено',
                    enable: 'Включить',
                    enabled: 'Включено',
                    idpMetadata: 'Метаданные IdP',
                    idpMetadataDesc: 'Укажите URL или вставьте XML. Если заполнены оба поля, используется URL.',
                    keepExistingRole: 'Сохраните существующие роли и локальные разрешения.',
                    loginWith: 'Войти через {provider}',
                    mappingResult: 'Результат сопоставления',
                    metadataRequired: 'Укажите URL или XML метаданных IdP.',
                    metadataURLHelper: 'Сервер загружает и проверяет метаданные при тестировании и сохранении.',
                    metadataURLInvalid: 'Введите корректный HTTPS URL метаданных без учетных данных и фрагмента.',
                    metadataURLRecommended: 'URL метаданных (рекомендуется)',
                    metadataXML: 'XML метаданных',
                    metadataXMLHelper: 'Используйте, если IdP не предоставляет доступный URL метаданных.',
                    metadataXMLInvalid: 'Введите корректный XML метаданных EntityDescriptor.',
                    metadataXMLPlaceholder: 'Вставьте <EntityDescriptor>...</EntityDescriptor>',
                    nameAttribute: 'Атрибут имени пользователя',
                    nameAttributeHelper:
                        'Считывает этот атрибут из проверенного SAML Assertion и сопоставляет его с именем пользователя NexaCP.',
                    nameAttributePlaceholder: 'Например: uid, username или account',
                    nameAttributeRequired: 'Введите атрибут имени пользователя.',
                    notConfigured: 'Не настроено',
                    or: 'или',
                    pageDesc: 'Подключите корпоративный SSO через метаданные IdP и настройте его на одной странице.',
                    plannedHandling: 'Плановая обработка',
                    privateKeyFileInvalid: 'Выберите корректный файл закрытого ключа PEM.',
                    recentTestSuccess: 'Последний тест прошел успешно: {0}',
                    restore: 'Восстановить',
                    restored: 'Были восстановлены последние сохраненные настройки SAML2.',
                    roleHandling: 'Обработка ролей',
                    rolesLoadFailed:
                        'Не удалось загрузить роли. Повторите попытку, прежде чем выбирать роль по умолчанию.',
                    selectFile: 'Выбрать файл',
                    serviceStatus: 'Состояние службы',
                    serviceStatusDesc: 'Перед включением SAML2 текущая конфигурация должна пройти проверку.',
                    settingLoadFailed: 'Не удалось загрузить настройки SAML2.',
                    settingLoadFailedHelper:
                        'Форма заблокирована, чтобы избежать сохранения пустой конфигурации по умолчанию поверх текущих настроек. Повторите попытку после восстановления соединения.',
                    spCertificate: 'Сертификат SP',
                    spCertificateHelper:
                        'Публикуется в метаданных SP, чтобы IdP мог проверять запросы на вход и выход.',
                    spCredentials: 'Закрытый ключ и сертификат SP',
                    spCredentialsDesc:
                        'Используются для подписи сообщений входа и выхода. Политика подписи и проверки задана сервером.',
                    spEntityID: 'SP Entity ID',
                    spEntityIDHelper:
                        'Уникальный идентификатор SP. Должен совпадать с Entity ID или Audience в IdP и одновременно служит URL метаданных SP.',
                    acsURL: 'ACS URL',
                    sloURL: 'SLO URL',
                    spPrivateKey: 'Закрытый ключ SP',
                    spPrivateKeyHelper:
                        'Используется для подписи AuthnRequest и сообщений выхода. Ключ хранится в зашифрованном виде и никогда не отображается.',
                    syncLogout: 'Синхронный выход',
                    syncLogoutHelper: 'Выход из NexaCP или IdP также завершает сеанс на другой стороне.',
                    testBeforeBrowserTest: 'Проверьте текущую конфигурацию перед запуском проверки входа в браузер.',
                    testBeforeEnable:
                        'Проверьте текущую конфигурацию, прежде чем включать или сохранять важные изменения.',
                    testConfiguration: 'Проверить конфигурацию',
                    unsavedChanges: 'Есть несохраненные изменения SAML2.',
                    usedAttribute: 'Сопоставление имени пользователя',
                    usersAndRoles: 'Пользователи и роли',
                    usersAndRolesDesc:
                        'Настройте сопоставление имени пользователя панели, а также узел и роль по умолчанию для создания пользователя при первом входе.',
                },
                ldap: {
                    basic: 'Основные настройки',
                    loginTitle: 'Вход через LDAP',
                    loginWith: 'Войти через LDAP',
                    backToLocalLogin: 'Вернуться ко входу в панель',
                    enable: 'Включить',
                    enabled: 'Включено',
                    disabled: 'Отключено',
                    ...
                    userSearchDesc:
                        'Установите базу поиска пользователей и фильтр, затем сопоставьте атрибут LDAP, используемый как NexaCP name.',
                    ...
                    attributeMapTooltip: 'Сопоставление JSON поля NexaCP name с атрибутом LDAP.',
                    attributeMapHelper: 'Установите атрибут LDAP, сопоставленный с полем NexaCP name.',
                    advanced: 'Расширенные настройки',
                    advancedDesc: 'Настройте разбиение запросов TLS и LDAP.',
                    strictSync: 'Строгая синхронизация',
                    strictSyncTooltip:
                        'После полной обработки статус аутентификации пользователей, отсутствующих в этом источнике LDAP, помечается как «Не найден в LDAP», но пользователи не удаляются.',
                    strictSyncHelper:
                    ...
                    sync: {
                        ...
                        description:
                            'Чтение полного каталога LDAP по расписанию и поддержка импортированных пользователей LDAP в NexaCP.',
                        ...
                        strictSyncHelper:
                            'После полной синхронизации отсутствующие в LDAP пользователи помечаются как «Не найден в LDAP», а их сеансы завершаются без удаления пользователей, ролей или разрешений.',
                        ...
                        runConfirmDescription:
                            'Статус аутентификации пользователей, отсутствующих в полном запросе LDAP, будет помечен как «Не найден в LDAP», а их активные сеансы будут очищены. Продолжать?',
                    ...
                    testLoginDesc:
                        'Привяжите учетные данные пользователя AD/LDAP только для проверки аутентификации. Сеанс NexaCP не создается.',
        ...
        helper: {
            ...
            settingContent1: 'Установите пользовательское приветственное сообщение на странице входа в NexaCP.',
            ...
            appContent1: 'Легко управляйте сервером NexaCP в любое время и в любом месте.',
            ...
            vllmContent1:
                'Интегрируйте распределённые экземпляры vLLM в NexaCP и централизованно отслеживайте версии, состояние работы и рабочие каталоги.',
        ...
        node: {
            ...
            healthCheckFrequency: 'Частота автоматической проверки',
            healthCheckFrequencyHelper:
                'Автоматически проверяет состояние узлов с заданной частотой. Введите 0, чтобы отключить автоматические проверки.',
            healthCheckFrequencyLimit:
                'Частота проверки не может превышать один день и должна быть неотрицательным целым числом.',
            autoCheckFailedNodes: 'Автоматически проверять недоступные узлы',
            autoCheckFailedNodesHelper:
                'Во время автоматической проверки также проверять узлы со статусом сбоя или неисправности. Действует, только если частота проверки не равна 0.',
            loadFailedNodeResources: 'Обновлять ресурсы недоступных узлов',
            loadFailedNodeResourcesHelper:
                'При обновлении списка узлов также запрашивать ресурсы узлов со статусом сбоя или неисправности.',
            ...
            withProxyHelper:
                'Для доступа к дочернему узлу будет использован системный прокси {0}, заданный в настройках панели. Продолжить?',
            withoutProxyHelper:
                'Доступ к дочернему узлу больше не будет использовать системный прокси, заданный в настройках панели. Продолжить?',
            ...
            panelExist:
                'Обнаружено, что на этом узле работает служба NexaCP V1. Перед добавлением обновите до V2 с помощью скрипта миграции.',
            coreExist:
            ...
            oldDataExist:
                'Обнаружены исторические данные NexaCP V2 на этом узле. Текущие настройки будут перезаписаны следующей информацией:',
            ...
            uninstallHelper: 'Это удалит все данные NexaCP, связанные с узлом. Выбирайте осторожно!',
            ...
            dashboardSetting: 'Настройки обзора',
            keepOneDashboardComponent: 'Оставьте хотя бы один раздел обзора',
        },
        customApp: {
        ...
        vm: {
            ...
            disk: 'Диск',
            overview: 'Обзор',
            kvmUnavailable: 'Доступные средства аппаратной виртуализации KVM не обнаружены.',
            kvmCheckCpu: 'Убедитесь, что процессор хоста поддерживает виртуализацию Intel VT-x или AMD-V.',
            kvmCheckBios: 'Включите параметры виртуализации в BIOS/UEFI.',
            kvmCheckModule: 'Убедитесь, что модуль ядра kvm, kvm_intel или kvm_amd загружен правильно.',
            kvmCheckDevice:
                'Убедитесь, что /dev/kvm существует, а текущая среда не является контейнером или облачным хостом без поддержки KVM.',
            abnormal: 'Неисправно',
            resourceOverview: 'Обзор ресурсов',
            cpuAllocated: 'Выделено CPU',
            memoryAllocated: 'Выделено памяти',
            storageUsed: 'Использовано хранилища',
            riskReminder: 'Предупреждения о рисках',
            noRisk: 'Рисков нет',
            runtimeHealth: 'Состояние среды выполнения',
            runtimeAbnormal: 'Среда выполнения ВМ работает ненормально',
            noDependency: 'Нет данных проверки зависимостей',
            storageOverview: 'Обзор хранилища',
            totalAllocated: 'Рассчитано по общей конфигурации ВМ',
            runningAllocated: 'Выделено работающим ВМ: {0}',
            storageAvailable: 'Доступно: {0}',
            inProgress: 'Выполняется',
            needAttention: 'Требует внимания',
            normal: 'Нормально',
            environmentRisk: 'Среда выполнения ВМ не готова. Исправьте зависимости или службы виртуализации.',
            storageRisk: 'Использование пула хранилища {0} достигло {1}%.',
            abnormalRisk: 'ВМ в неисправном состоянии: {0}.',
            pausedRisk: 'Приостановлено ВМ: {0}.',
            memoryRisk: 'Выделение памяти ВМ достигло {0}%.',
            ...
            sourceVM: 'Исходная ВМ',
            templateSize: 'Размер шаблона',
            ...
            monitor: 'Мониторинг',
            monitorNotReady: 'Виртуальная машина не запущена. Данные мониторинга недоступны.',
            monitorLoadFailed: 'Не удалось получить данные мониторинга ВМ.',
            monitorLoadFailedWithReason: 'Не удалось получить данные мониторинга ВМ: {0}',
            rename: 'Переименовать',
            newName: 'Новое имя',
            renameHelper: 'Введите новое имя ВМ. Перед переименованием ВМ должна быть выключена.',
            renameConfirm: 'Переименовать виртуальную машину [{0}] в [{1}]?',
            renameRunningHelper: 'Выключите виртуальную машину перед переименованием.',
            cpuUsage: 'Использование CPU',
            memoryUsage: 'Использование памяти',
            diskIO: 'Ввод-вывод диска',
            networkIO: 'Сетевой ввод-вывод',
            diskReadWrite: 'Чтение / Запись диска',
            networkRxTx: 'Приём / Передача по сети',
            rx: 'RX',
            tx: 'TX',
            console: 'Консоль',
            ...
            recoverSnapshot: 'Восстановить снимок',
            snapshotSize: 'Использовано',
            currentSnapshot: 'Текущий',
            snapshotEmpty: 'Нет снимков',
            snapshotHelper:
                'Снимок сохраняет текущее состояние ВМ как точку восстановления. Последующие изменения записываются в разностный файл без изменения исходного диска. Восстановление снимка возвращает ВМ к этому состоянию.',
            snapshotOperationHelper:
                'Текущий снимок нельзя удалить. Восстановить снимок можно только при выключенной виртуальной машине.',
            snapshotRecoverConfirm:
                'Восстановить виртуальную машину [{1}] до снимка [{0}]? Диск ВМ будет возвращён к состоянию снимка.',
