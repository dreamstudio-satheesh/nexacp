...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: '仅将现有密码保存到 NexaCP，不会修改 MySQL 用户密码。',
        noUserBind: '不绑定',
        pgBindHelper: '该操作用于创建新用户并将其绑定到目标数据库，暂不支持选择已存在于数据库中的用户。',
        pgSuperUser: '超级用户',
        loadFromRemoteHelper: '此操作将同步服务器上的数据库、用户及授权信息到 NexaCP，是否继续？',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: '该模型并非通过 NexaCP 下载，无相关拉取日志。',
        ...
        aiProxy: {
            ...
            lastUsedAt: '最近使用时间',
            validityPeriod: '有效期',
            keepCurrentValidity: '保持当前有效期',
            neverExpires: '永不过期',
            validForDays: '有效 {0} 天',
            customDays: '自定义天数',
            enterValidityDays: '请输入有效天数',
            currentExpiresAt: '当前到期时间：{0}',
            currentNeverExpires: '当前为永不过期',
            expiresAt: '到期时间',
            expired: '已过期',
            reactivate: '重新激活',
            ...
            currentLimit: '当前 / 上限',
            utilization: '利用率',
            autoRefreshSeconds: '每 {0} 秒自动刷新',
            zeroMeansUnlimited: '设置为 0 表示不限制。',
            groupMaxConcurrencyDesc: '限制该用户组所有 API Key 的活跃请求总数，设置为 0 表示不限制。',
            apiKeyMaxConcurrencyDesc: '限制该用户组内每个 API Key 的活跃请求数，设置为 0 表示不限制。',
            schedulingReason: '调度原因',
            schedulingAffinity: '亲和命中',
            schedulingLeastUtilized: '最低利用率',
            schedulingPriorityFallback: '优先级降级',
            schedulingRetry: '故障重试',
            queueSize: '等待队列大小',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '参数将追加到 supergateway 启动命令，不支持修改由 NexaCP 管理的传输、端口、路径和协议参数',
            testConnection: '测试连接',
    ...
    container: {
        ...
        containerDeleteHelper:
            '检测到容器来源于应用商店，删除容器不会将其从 NexaCP 中完全移除。如需彻底删除，请前往应用商店-『已安装』或『运行环境』等菜单中操作。是否继续？',
        start: '启动',
        stop: '停止',
        restart: '重启',
        kill: '强制停止',
        ...
        composeHelper: '通过 NexaCP 编辑或模版创建的编排，将保存在 {0}/docker/compose 路径下',
        deleteFile: '删除文件',
        ...
        exited: '已停止',
        running: '运行中 ( {0} / {1} )',
        composeDetailHelper: '该 compose 为 NexaCP 编排外部创建。暂不支持启停操作。',
        composeOperatorHelper: '将对 {0} 进行 {1} 操作，是否继续？',
        composeDownHelper: '将停止并删除 {0} 编排下所有容器及网络，是否继续？',
        composeEnvHelper2: '该编排为 NexaCP 应用商店创建，请在已安装应用中修改环境变量。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日志文件会备份到 NexaCP 的 backup 目录下',
    ...
    file: {
        ...
        previewLargeFile: '预览',
        panelInstallDir: 'NexaCP 安装目录不能删除',
        wgetTask: '下载任务',
    ...
    setting: {
        ...
        timeZoneHelper: '时区修改依赖系统 timedatectl 服务，重启 NexaCP 服务后生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉矶',
        timeZoneNY: '纽约',
        ntpALi: '阿里云',
        ...
        developerModeHelper: '获取 NexaCP 的预览版本，以分享有关新功能和更新的反馈',
        ...
        ignoreHelper: '快照时将使用该规则对 NexaCP 数据目录进行压缩备份，请谨慎修改。',
        ignoreHelper1: '一行一个，例： \n*.log\n/opt/1panel/cache',
        status: '快照状态',
        panelInfo: '写入 NexaCP 基础信息',
        panelBin: '备份 NexaCP 系统文件',
        daemonJson: '备份 Docker 配置文件',
        appData: '备份 NexaCP 已安装应用',
        panelData: '备份 NexaCP 数据目录',
        backupData: '备份 NexaCP 本地备份目录',
        compress: '制作快照文件',
        upload: '上传快照文件',
        recoverDetail: '恢复详情',
        ...
        recoverHelper1: '恢复需要重启 Docker 以及 NexaCP 服务',
        ...
        rollback: '回滚',
        rollbackHelper:
            '即将回滚本次恢复，回滚将替换所有本次恢复的文件，过程中可能需要重启 Docker 以及 NexaCP 服务，是否继续？',

        upgradeRecord: '更新记录',
        upgrading: '正在升级中，请稍候...',
        upgradeHelper: '升级操作需要重启 NexaCP 服务，是否继续？',
        noUpgrade: '当前已经是最新版本',
        versionHelper: 'NexaCP 版本号命名规则为： [大版本].[功能版本].[Bug 修复版本]，例：',
        ...
        bindDomainHelper: '设置域名绑定后，仅能通过设置中域名访问 NexaCP 服务',
        bindDomainHelper1: '绑定域名为空时，则取消域名绑定',
        bindDomainWarning: '设置域名绑定后，将退出当前登录，且仅能通过设置中域名访问 NexaCP 服务，是否继续？',
        allowIPs: '授权 IP',
        unAllowIPs: '取消授权',
        unAllowIPsWarning: '授权 IP 为空将允许所有 IP 访问系统，可能造成系统不安全，是否继续？',
        allowIPsHelper: '设置授权 IP 后，仅有设置中的 IP 可以访问 NexaCP 服务',
        allowIPsWarning: '设置授权 IP 后，仅有设置中的 IP 可以访问 NexaCP 服务，是否继续？',
        ...
        mfaCode: '验证码',
        mfaInterval: '刷新时间（秒）',
        mfaTitleHelper: '用于区分不同 NexaCP 主机，修改后请重新扫描或手动添加密钥信息！',
        mfaIntervalHelper:
        ...
        passkeyPrereqBindDomain: '已设置 NexaCP 域名绑定',
    ...
    license: {
        ...
        securityWarningContent:
            'NexaCP 需要以具备系统管理权限的用户运行，非官方许可证或被篡改版本可能导致服务器失控、数据泄露等严重安全风险。请通过飞致云官方渠道获取许可证和安装包。',
        ...
        node: '升级商业版可以使用 NexaCP 管理多台 linux 服务器。',
        ...
        vllm: '升级商业版可将 vLLM 服务统一纳入 NexaCP 管理，集中完成部署、配置调整、状态运维与任务追踪，降低本地模型服务维护成本。',
        'model-downloader':
            '升级商业版可从 HuggingFace、ModelScope 或兼容镜像站搜索、下载并管理本地模型文件，统一维护本地模型目录与下载任务。',
    },
    clean: {
        scan: '开始扫描',
        scanHelper: '轻松梳理 NexaCP 运行期间积累的垃圾文件',
        clean: '立即清理',
        reScan: '重新扫描',
    ...
    ssl: {
        ...
        shell: '脚本内容',
        shellHelper:
            '脚本默认执行目录为 NexaCP 安装目录，如果有推送证书，那么执行目录为证书推送目录。默认超时时间 30 分钟',
    ...
    firewall: {
        ...
        changeStrategyHelper: '即将把 [{1}] 的 {0} 策略修改为 [{2}]，设置后 {0} 将按 [{2}] 策略对外访问，是否继续？',
        strategy: '策略',
        accept: '允许',
        drop: '拒绝',
        anyWhere: '所有 IP',
    ...
    xpack: {
        ...
        setting: {
            setting: '界面设置',
            title: '面板描述',
            titleHelper: '将显示在用户登录页面（例如：Linux 服务器运维管理面板，建议 8-15 个字符）',
            logo: 'Logo (不带文字)',
            ...
            loginBgColor: '背景颜色',
            loginBgColorHelper: '将在登录页面显示为背景颜色',
            image: '图片',
            bgColor: '背景色',
            loginGroup: '登录页',
        ...
        helper: {
            ...
            settingContent1: '在 NexaCP 登录页上设置自定义的欢迎语。',
            ...
            appTitle1: '灵活管理面板',
            appContent1: '随时随地轻松管理你的 NexaCP 服务器。',
            appTitle2: '全面服务信息',
            ...
            vllmTitle1: '统一纳管',
            vllmContent1: '将分散的 vLLM 服务统一接入 NexaCP，集中查看实例、版本、状态与运行目录。',
            vllmTitle2: '快速部署',
        ...
        node: {
            ...
            healthCheck: '健康检查',
            healthCheckFrequency: '自动检查频率',
            healthCheckFrequencyHelper: '按设置的频率自动检查节点健康状态。输入 0 时关闭自动检查。',
            healthCheckFrequencyLimit: '检查频率不能超过一天，且必须为非负整数。',
            autoCheckFailedNodes: '自动检查失败节点',
            autoCheckFailedNodesHelper: '自动检查时，同时检查状态为失败或异常的节点。仅在检查频率不为 0 时生效。',
            loadFailedNodeResources: '刷新失败节点资源信息',
            loadFailedNodeResourcesHelper: '刷新节点列表时，同时查询状态为失败或异常的节点资源信息。',
            ...
            checkPort: '检查节点端口可达',
            panelExist: '检查到该节点正在运行 NexaCP V1 服务，请先通过迁移脚本升级至 V2 后再进行添加。',
            coreExist:
            ...
            oldDataExist: '检查到该节点存在 NexaCP V2 历史数据，将使用以下信息覆盖当前设置',
            ...
            uninstall: '删除节点数据',
            uninstallHelper: '将删除节点所有 NexaCP 相关数据，谨慎选择！',
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreWebsiteMonitorAvailability: '网站监控请求可用率 {0}% 低于阈值',
            ...
            auth: {
                ...
                oidc: {
                    ...
                    privateNetworkIdPHelper:
                        '显式允许私有地址；元数据、回环、链路本地、异常重定向和 DNS 重绑定仍会阻止。',
                ...
                saml2: {
                    ...
                    spEntityID: 'SP 实体 ID',
                    spEntityIDHelper:
                        'SP 唯一标识，需与身份提供商中配置的实体 ID 或受众标识一致，同时也是 SP 元数据地址。',
                    acsURL: 'ACS 地址',
                    sloURL: 'SLO 地址',
                    spPrivateKey: 'SP 私钥',
        ...
        customApp: {
            ...
            postNode: '同步至子节点',
            postNodeHelper: '将自定义应用仓库包同步到子节点安装目录下的 tmp/customApp/apps.tar.gz',
            nodes: '节点',
            selectNode: '选择节点',
            selectNodeError: '请选择节点',
        ...
        vm: {
            ...
            snapshotOperationHelper: '当前快照无法删除；仅可在虚拟机关机时恢复快照。',
