...
const message = {
    commons: {
        ...
        msg: {
            ...
            offlineTips: 'Çevrimdışı sürüm bu işlemi desteklemiyor',
        ...
        login: {
            ...
            otherLoginMethods: 'Diğer giriş yöntemleri',
        ...
        rule: {
            ...
            vmName: 'İngilizce harfler, sayılar, ".", "-" ve "_" desteklenir; uzunluk 1-64 olmalı ve bir harf veya sayıyla başlamalıdır.',
            vmNetwork:
                'İngilizce harfler, sayılar, ".", ":", "-" ve "_" desteklenir; uzunluk 1-64 olmalı ve bir harf veya sayıyla başlamalıdır.',
        },
        res: {
    ...
    home: {
        ...
        loadAverage: 'Son {0} dakikadaki yük ortalaması',
        load: 'Yük',
    ...
    database: {
        ...
        deleteUserHelper: '" girerek bu kullanıcıyı silin',
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            keepCurrentValidity: 'Mevcut süreyi koru',
            neverExpires: 'Süresiz',
            validForDays: '{0} gün geçerli',
            customDays: 'Özel gün sayısı',
            enterValidityDays: 'Geçerlilik süresini gün olarak girin',
            currentExpiresAt: 'Mevcut sona erme: {0}',
            currentNeverExpires: 'Şu anda süresiz',
            ...
            autoRefreshSeconds: 'Her {0} saniyede otomatik yenilenir',
            zeroMeansUnlimited: 'Sınırsız için 0 olarak ayarlayın.',
            groupMaxConcurrencyDesc: 'Gruptaki tüm API Key etkin isteklerini sınırlar. 0 sınırsızdır.',
            apiKeyMaxConcurrencyDesc: 'Gruptaki her API Key için etkin istekleri sınırlar. 0 sınırsızdır.',
            schedulingReason: 'Zamanlama nedeni',
            schedulingAffinity: 'Yakınlık',
            schedulingLeastUtilized: 'En az kullanılan',
            schedulingPriorityFallback: 'Öncelik geri dönüşü',
            schedulingRetry: 'Yeniden deneme',
            ...
            upstreamDuration: 'Upstream süresi',
            ...
            embeddingModels: 'Embedding Modelleri',
            ...
            contentAction: 'Eylem',
            actionBlock: 'Engelle',
            actionAuditOnly: 'Yalnızca denetle',
            actionDropHistory: 'Geçmişi sil',
            severity: 'Önem Derecesi',
            severityHigh: 'Yüksek',
            severityMedium: 'Orta',
            severityLow: 'Düşük',
            sensitiveWord: 'Hassas kelime',
            sensitiveGroup: 'Hassas kelime grubu',
            sensitiveWordCount: 'Kelimeler',
            normalizedWord: 'Normalleştirilmiş kelime',
            matchedWords: 'Eşleşen kelimeler',
            matchedGroups: 'Eşleşen gruplar',
    ...
    container: {
        ...
        cleanLogscope: 'Temizleme türü',
        downLogHelper1: 'Bu, {0} konteynerinden tüm logları indirecektir. Devam etmek istiyor musunuz?',
        downLogHelper2: 'Bu, {0} konteynerindeki en son {1} günlük kaydını indirecektir. Devam etmek istiyor musunuz?',
        cleanLogHelper:
        ...
        mirrorsHelper:
            "İmaj işlemlerinde önce kayıt defteri yansıtma URL'lerini kullanın. Kayıt defteri yansıtmalarını devre dışı bırakmak için boş bırakın.",
    ...
    file: {
        ...
        shareExpire: 'Geçerlilik süresi',
        shareExpire1h: '1 saat',
        shareExpire6h: '6 saat',
        shareExpire24h: '24 saat',
        shareExpire3d: '3 gün',
        shareExpire7d: '7 gün',
        sharePassword: 'Parola',
        sharePasswordPlaceholder: 'Parola kullanmamak için boş bırakın',
        shareMaxDownloads: 'En fazla indirme',
        shareMaxDownloadsHint: '0 sınırsız anlamına gelir',
        shareGenerate: 'Bağlantı oluştur',
        shareRegenerate: 'Yeniden paylaş',
        shareClose: 'Kapat',
        shareCancel: 'Paylaşımı iptal et',
        shareCancelConfirm: 'Bu dosya paylaşımını iptal etmek istediğinize emin misiniz?',
        shareDetail: 'Ayrıntılar',
        shareCopyLink: 'Bağlantıyı kopyala',
        shareLinkLabel: 'Paylaşım bağlantısı',
        shareQrCode: 'QR kodu',
        shareQrDialogTitle: 'Paylaşım bağlantısı QR kodu',
        shareQrDialogHelper: 'Bu QR kodunu mobil cihazınızla tarayın',
        shareSaveImage: 'Görüntüyü kaydet',
        shareOpenImage: 'Görüntüyü aç',
        shareExtractFile: 'Dosyayı al',
        shareDownloadingHint: 'Dosyanız hazırlanıyor. İndirme kısa süre içinde başlayacak.',
        shareInvalid: 'Geçersiz veya süresi dolmuş paylaşım bağlantısı',
        shareDownloadFailed: 'İndirme başarısız oldu. Daha sonra tekrar deneyin',
        sharePasswordRequired: 'Erişim parolası',
        sharePasswordRequiredInput: 'Paylaşım parolasını girin',
        sharePasswordLengthHint: 'Paylaşım parolası 4-256 karakter uzunluğunda olmalıdır',
        shareDownloadPasswordTip: 'Bu bağlantı parola korumalıdır. İndirmeden önce parolayı girin.',
        shareRiskAlert:
            'Paylaşılan bağlantılar güvenlik riski taşıyabilir. Yalnızca güvendiğiniz kişilerle paylaşın ve hassas bilgileri açığa çıkarmayın.',
        sharePasswordSeparate:
            'Bir parola ayarlandı. Güvenli biçimde paylaşın. Alıcılar URL’ye &password=... eklemeli veya parola sorgu parametresini iletebilen bir istemci kullanmalıdır.',
        shareExpiresAt: 'Bitiş zamanı',
        paste: 'Yapıştır',
    ...
    website: {
        ...
        ipHashBackupErr: 'IP hash yedek düğümleri desteklemez',
        ...
        shareCache: 'Önbellek Sayısı Bellek Boyutu',
        cacheExpire: 'Önbellek Son Kullanma Süresi',
        shareCacheHelper: 'Yaklaşık olarak 1M bellek başına 8000 önbellek nesnesi saklanabilir',
    ...
    php: {
        ...
        display_errors: 'Ayrıntılı hata bilgilerinin görüntülenip görüntülenmeyeceği',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                scoreSSLExpired: '{0} sertifikasının süresi doldu',
                scoreSSLHigh: '{0} sertifikasının {1} günü kaldı',
                scoreSSLMedium: '{0} sertifikasının {1} günü kaldı',
                scoreWebsiteExpired: '{0} web sitesinin süresi doldu',
                ...
                scoreWebsiteMonitorAvailability: 'Web sitesi izleme istek kullanılabilirliği %{0} eşiğin altında',
                ...
                waf: 'WAF',
                siteAvailability: 'İstek Kullanılabilirliği',
                ...
                serviceEnabledButAbnormal: 'Etkin, ancak durumu anormal',
                ...
                disabledCronjobTasks: 'Devre dışı zamanlanmış görevler',
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    accessMode: 'Bağlantı modu',
                    accessModeDesc: "Kimlik sağlayıcının desteklediği durumlarda standart Discovery'i kullanın.",
                    actionCreate: 'Kullanıcı oluştur',
                    actionKeepName: 'Mevcut kullanıcı adını koruyun',
                    actionPending: 'Sonuç bekleniyor',
                    actionReject: 'Giriş yapmayı reddet',
                    actionUpdate: 'Kimlik bilgilerini güncelle',
                    advanced: 'Gelişmiş ayarlar',
                    advancedDesc:
                        'Sağlayıcı bir uyumluluk seçeneği gerektirmediği sürece güvenli varsayılanları koruyun.',
                    assignDefaultRole: 'Varsayılan rolü ata: {role}',
                    authorizationEndpoint: 'Authorization Endpoint',
                    authorizationEndpointInvalid: 'Geçerli bir Authorization Endpoint girin.',
                    authorizationFlow: 'Yetkilendirme akışı',
                    automatic: 'Otomatik',
                    automaticPolicy: 'Otomatik işleme politikası',
                    automaticPolicyDesc: 'Bu kurallar arka uç tarafından uygulanır ve yönetici anahtarları değildir.',
                    basic: 'Temel ayarlar',
                    basicDesc: 'Sağlayıcı modunu seçin, ardından istemciyi ve geri aramayı yapılandırın.',
                    browserTest: 'Tarayıcı test girişi',
                    browserTestConflict: 'Kimlik doğrulandı ancak kullanıcı adı çakışıyor',
                    browserTestConflictHelper:
                        'Eşlenen kullanıcı adı başka bir kimliğe aittir ve talep edilmeyecektir.',
                    browserTestExpired: 'Tarayıcı testinin süresi doldu',
                    browserTestExpiredHelper:
                        'Yeni bir tarayıcı testi başlatın ve süresi dolmadan yetkilendirmeyi tamamlayın.',
                    browserTestFailed: 'Tarayıcı testi başarısız oldu',
                    browserTestFailedHelper:
                        'Kimlik önizlemesi tamamlanamadı. Yerelleştirilmiş arka uç hatasını inceleyin.',
                    browserTestIsolation:
                        'Bu işlem gerçek bir yetkilendirme gidiş-dönüşü gerçekleştirir ancak kullanıcı oluşturmaz veya güncellemez, rol atamaz ya da kimliği doğrulanmış bir panel oturumu oluşturmaz.',
                    browserTestPopupBlocked:
                        'Bu site için açılır pencerelere izin verin, ardından tarayıcı testini yeniden başlatın.',
                    browserTestPopupClosed: 'Yetkilendirme penceresi test tamamlanmadan kapatıldı.',
                    browserTestSuccess: 'Provider doğrulaması başarılı oldu',
                    browserTestSuccessHelper:
                        'Kimlik eşlemenin önizlemesi, kullanıcıları veya oturumları değiştirmeden yapıldı.',
                    browserTestTitle: 'OIDC tarayıcı testi girişi',
                    browserTestWaiting: 'Provider yetkilendirmesi bekleniyor',
                    ...
                    configurationHighRiskPassed:
                        'Yapılandırma başarılı ancak yüksek riskli uyumluluk seçenekleri içeriyor.',
                    configurationHighRiskTag: 'Yüksek riskli yapılandırma başarılı oldu',
                    configurationNotTested: 'Mevcut konfigürasyon test edilmemiştir.',
                    ...
                    configurationTestResult: 'Yapılandırma testi sonucu',
                    configurationTestResultDesc:
                        "Bu, yalnızca Discovery'i ve yeteneklerini kontrol eder; yetkilendirme kodunu değiştirmez veya Client Secret'i kanıtlamaz. Uçtan uca doğrulama için tarayıcı testi girişini kullanın.",
                    configurationTestSuccess: 'OIDC yapılandırma testi başarılı oldu.',
                    configurationTesting: 'Mevcut OIDC yapılandırması test ediliyor…',
                    configurationTestingTag: 'Test',
                    configureSecret: 'Sırrı yapılandır',
                    conflictExistingRename: "Bağlı bir subject, dolu olan yeni bir name'i döndürür",
                    conflictExistingRenameResult:
                        "Mevcut User.Name'i koruyun ve bağlı kullanıcının oturum açmasına izin verin",
                    conflictLDAP: 'LDAP kullanıcısı',
                    conflictLocal: 'Yerel kullanıcı',
                    conflictNewAvailable: 'Yeni subject ve eşlenen name mevcut',
                    conflictNewAvailableResult: 'Kurumsal kullanıcı oluşturun ve varsayılan rolü atayın',
                    conflictNone: 'Çatışma yok',
                    conflictOIDC: 'Başka bir OIDC kimliği',
                    conflictOccupied: 'Eşlenen name yerel bir LDAP veya başka bir OIDC kimliğine aittir',
                    conflictOccupiedResult: 'Yeni kimliği reddet; asla otomatik olarak bağlama veya birleştirme',
                    conflictType: 'Çatışma türü',
                    connectionSecurity: 'Bağlantı güvenliği',
                    ...
                    customCA: 'Özel CA',
                    customCAHelper:
                        'Yalnızca bu kimlik doğrulama kaynağı için geçerlidir ve hiçbir zaman günlüklere yazılmaz.',
                    ...
                    disableConfirm:
                        "OIDC'in devre dışı bırakılması, bu kaynağın kullanıcılarının erişimini anında geçersiz kılar. Devam etmek?",
                    disableDiscardConfirm:
                        "OIDC'in devre dışı bırakılması acil bir eylemdir: yalnızca oturum açma girişini kapatır ve bu kaynağın kullanıcıları için erişimi anında geçersiz kılar. Client Secret değişiklikleri de dahil olmak üzere bu sayfadaki diğer kaydedilmemiş değişiklikler silinecektir. Devam etmek?",
                    disableTitle: "OIDC'i devre dışı bırakın",
                    disabled: 'Devre dışı',
                    discoveryAllowlist: 'Discovery ∩ güvenlik izin verilenler listesi',
                    enable: 'Etkinleştir',
                    enableAfterSave: 'Başarılı bir kaydetme işleminden sonra OIDC etkinleştirilecektir.',
                    enabled: 'Etkin',
                    ...
                    fixedNoTokenPersistence: "Token'ler, Claims ve verifier hiçbir zaman kalıcı olmaz",
                    fixedSecurityPolicy: 'Her zaman uygulanır; yapılandırma gerekmez',
                    fixedStateNonce: 'Bir kerelik state ve nonce',
                    fixedTokenValidation: 'ID Token imzası ve Claims doğrulaması',
                    highRiskSaveConfirm:
                        'Bu etkinleştirilmiş yapılandırma, yüksek riskli uyumluluk seçeneklerini içerir. Yalıtılmış ortamın bunları gerektirdiğini doğrulayın.',
                    highRiskTitle: 'Yüksek riskli OIDC yapılandırması',
                    hs256Compatibility: 'HS256 (uyumluluk)',
                    hs256KeyHelper:
                        "HS256 her zaman bu kaynağın Client Secret'ini kullanır ve ayrı bir imzalama anahtarını kabul etmez.",
                    hs256Warning:
                        "HS256, ID Token imzaları için paylaşılan bir simetrik sır kullanır. Bunu yalnızca Provider'in asimetrik bir algoritma kullanamadığı durumlarda kullanın.",
                    identityBindingPolicy:
                        "Kimlik AuthSourceID + issuer + subject'e sabitlenmiştir. Kullanıcı adının eşleşmesi başka bir hesabın otomatik olarak sahiplenilmesine yol açmaz.",
                    identityMissing: 'Kimlik etkin değil',
                    issuer: 'Issuer URL',
                    issuerHelper: 'ID Token iss değeri ve Discovery issuer bu değerle tam olarak eşleşmelidir.',
                    issuerInvalid: 'Sorgu veya parça olmadan geçerli bir HTTP veya HTTPS Issuer URL girin.',
                    issuerRequired: "Issuer URL'i girin.",
                    jwksRotation: 'Otomatik JWKS dönüşü',
                    jwksURI: 'JWKS URI',
                    jwksURIHelper: 'Anahtar kaynağı JWKS olduğunda asimetrik imzalama için gereklidir.',
                    jwksURIInvalid: 'Seçilen imzalama anahtarı kaynağı için geçerli bir JWKS URI girin.',
                    keepExistingRole: 'Mevcut rolleri ve yerel izinleri koruyun',
                    localSecurityData: 'Yerel güvenlik verileri',
                    localSecurityDataPolicy:
                        "Hiçbir zaman rollerin, MFA, API Keys, Passkeys'in veya yerel izinlerin üzerine yazmayın.",
                    localCredentialsManaged:
                        'Kullanıcı adı ve yerel parola OIDC tarafından yönetilir ve burada düzenlenemez. Roller, izinler, MFA, API Keys ve Passkeys yerel olarak yönetilmeye devam eder.',
                    ...
                    pkceHelper: "S256'i tercih edin. plain sınama yöntemi hiçbir zaman sunulmaz.",
                    pkceS256: 'S256 (önerilir)',
                    plannedHandling: 'Planlı kullanım',
                    privateNetworkIdP: "Özel ağ IdP'si",
                    privateNetworkIdPHelper:
                        'Açıkça özel adreslere izin verir; meta veriler, geridöngü, yerel bağlantı, yönlendirmeler ve DNS yeniden bağlama engellenmeye devam eder.',
                    privateNetworkWarning: 'Bu kimlik doğrulama kaynağı için özel ağ erişimi etkinleştirildi.',
                    protocolCompatibility: 'Protokol uyumluluğu',
                    protocolCompatibilityDesc: 'ID Token imza doğrulaması hiçbir zaman devre dışı bırakılamaz.',
                    providerAndClient: 'Provider ve istemci',
                    providerAndClientDesc:
                        'Client Secret yalnızca değiştirilebilir veya silinebilir ve sayfa tarafından asla geri döndürülmez.',
                    providerCapabilities: 'Provider yetenekleri',
                    recentTestSuccess: 'Son test başarılı oldu: {0}',
                    recommended: 'Tavsiye edilen',
                    rejectPlain: 'plain reddedildi',
                    ...
                    restore: 'Geri yükle',
                    restored: 'Son kaydedilen OIDC ayarları geri yüklendi.',
                    result: 'Sonuç',
                    ...
                    seconds: 'saniye',
                    secretClearHelper:
                        "Temizledikten sonra, OIDC'in yeniden etkinleştirilebilmesi için yeni bir Client Secret gereklidir.",
                    secretConfigured: 'Yapılandırılmış',
                    secretNotConfigured: 'Yapılandırılmadı',
                    secretPlaceholder: 'Yeni bir Client Secret girin',
                    secretReplaceHelper:
                    ...
                    signingAlgorithm: 'ID Token imzalama algoritması',
                    signingAlgorithmHelper:
                        'Yalnızca arka uç güvenliği izin verilenler listesindeki algoritmalar kullanılabilir.',
                    signingKey: 'İmza anahtarı',
                    signingKeyClientSecret: 'Client Secret (yalnızca HS256)',
                    signingKeyJWKS: 'Otomatik rotasyonlu JWKS URI',
                    signingKeySource: 'İmza anahtarı kaynağı',
                    ...
                    standardProtocolPolicyDesc:
                        'İmzalama yetenekleri otomatik olarak müzakere edilir; buraya herhangi bir imzalama anahtarı girilmez.',
                    staticSigningKey: 'Statik imzalama açık anahtarı',
                    staticSigningKeyHelper:
                        'Yalnızca açık anahtar materyali kabul edilir. Provider anahtarı değiştiğinde manuel olarak güncelleyin.',
                    staticSigningKeyPlaceholder: 'JWK, JWKS JSON veya PEM açık anahtarını yapıştırın',
                    staticSigningKeyRequired: 'Statik imzalama açık anahtarını sağlayın.',
                    staticSigningKeyWarning:
                        'Statik imzalama anahtarı otomatik olarak yenilenemez; Provider anahtar rotasyonu yapmadan önce güncelleyin.',
                    settingLoadFailed: 'OIDC ayarları yüklenemedi',
                    settingLoadFailedHelper:
                        'Geçerli ayarların üzerine boş bir varsayılan yapılandırmanın kaydedilmesini önlemek için form kilitlendi. Bağlantı kurtarıldıktan sonra yeniden deneyin.',
                    subsequentLogin: 'Sonraki giriş',
                    ...
                    tlsPrivateHTTP: 'HTTP · Yalnızca özel ağ (tehlikeli)',
                ...
                saml2: {
                    ...
                    actionPending: 'Sonuç bekleniyor',
                    actionReject: 'Giriş yapmayı reddet',
                    actionReuse: 'Bağlı kullanıcıyı kullan',
                    assignDefaultRole: 'Varsayılan rolü ata: {role}',
                    basic: 'Temel ayarlar',
                    basicDesc: 'Çoğu standart SAML2 kimlik sağlayıcısı için gereken ortak seçenekleri yapılandırın.',
                    browserTest: 'Oturum açmayı test et',
                    browserTestConflict: 'Kimlik doğrulandı ancak kullanıcı adı çakışıyor',
                    browserTestConflictHelper:
                        'Eşlenen kullanıcı adı başka bir kimliğe aittir ve talep edilmeyecektir.',
                    browserTestExpired: 'Tarayıcı testinin süresi doldu',
                    ...
                    browserTestSuccessHelper:
                        'Kimlik eşlemenin önizlemesi, kullanıcıları veya oturumları değiştirmeden yapıldı.',
                    browserTestTitle: 'SAML2 tarayıcı testi girişi',
                    browserTestWaiting: 'Provider yetkilendirmesi bekleniyor',
                    browserTestWaitingHelper:
                        'Yeni tarayıcı penceresinde oturum açma işlemini tamamlayın. Bu sayfa otomatik olarak güncellenecektir.',
                    certificateFileInvalid: 'Geçerli bir PEM, CRT veya CER sertifika dosyası seçin.',
                    ...
                    configurationTestSuccess: 'SAML2 yapılandırma testi başarılı oldu.',
                    configurationTesting: 'Mevcut SAML2 yapılandırması test ediliyor…',
                    conflictLDAP: 'LDAP kullanıcısı',
                    conflictLocal: 'Yerel kullanıcı',
                    conflictNone: 'Çatışma yok',
                    conflictOIDC: 'Başka bir OIDC kimliği',
                    conflictSAML2: 'Başka bir SAML2 kimliği',
                    conflictType: 'Çatışma türü',
                    credentialFileReadFailed: 'Kimlik bilgisi dosyası okunamadı.',
                    credentialFileTooLarge: 'Kimlik bilgisi dosyaları 256 KiB boyutunu aşmamalıdır.',
                    credentialsRequired: 'SP özel anahtarını ve sertifikasını yapılandırın.',
                    defaultRole: 'Yeni kullanıcı rolü',
                    defaultRoleHelper:
                        'Yalnızca ilk oluşturmada atanır; sonraki oturum açmalar yerel rolleri, MFA ve izinleri korur.',
                    defaultRolePlaceholder: 'Bir rol seçin',
                    defaultRoleRequired: 'Geçerli bir varsayılan rol seçin.',
                    disableConfirm:
                        'SAML2 devre dışı bırakıldığında yeni oturum açmalar hemen reddedilir ve kullanıcı oturumları geçersiz kılınır. Devam edilsin mi?',
                    disableDiscardConfirm:
                        'SAML2 devre dışı bırakıldığında bu sayfadaki diğer kaydedilmemiş değişiklikler atılır ve kullanıcı oturumları hemen geçersiz kılınır. Devam edilsin mi?',
                    disableTitle: 'SAML2’yi devre dışı bırak',
                    disabled: 'Devre dışı',
                    enable: 'Etkinleştir',
                    enabled: 'Etkin',
                    idpMetadata: 'IdP meta verileri',
                    idpMetadataDesc: 'Bir URL girin veya XML yapıştırın. İkisi de varsa URL önceliklidir.',
                    keepExistingRole: 'Mevcut rolleri ve yerel izinleri koruyun',
                    loginWith: '{provider} ile oturum aç',
                    mappingResult: 'Eşleme sonucu',
                    metadataRequired: 'IdP Metadata URL veya XML girin.',
                    metadataURLHelper: 'Arka uç, test ve kaydetme sırasında meta verileri indirip doğrular.',
                    metadataURLInvalid: 'Kimlik bilgisi veya parça içermeyen geçerli bir HTTPS meta veri URL’si girin.',
                    metadataURLRecommended: 'Meta veri URL’si (önerilen)',
                    metadataXML: 'XML meta verileri',
                    metadataXMLHelper: 'IdP erişilebilir bir meta veri URL’si sunmuyorsa bunu kullanın.',
                    metadataXMLInvalid: 'Geçerli bir EntityDescriptor meta veri XML’i girin.',
                    ...
                    or: 'veya',
                    pageDesc: 'IdP Metadata ile kurumsal SSO bağlantısını ortak ayarlarla tek sayfada yapılandırın.',
                    plannedHandling: 'Planlı kullanım',
                    privateKeyFileInvalid: 'Geçerli bir PEM özel anahtar dosyası seçin.',
                    recentTestSuccess: 'Son test başarılı oldu: {0}',
                    restore: 'Geri yükle',
                    restored: 'Son kaydedilen SAML2 ayarları geri yüklendi.',
                    roleHandling: 'Rol yönetimi',
                    rolesLoadFailed: 'Roller yüklenemedi. Varsayılan rolü seçmeden önce yeniden deneyin.',
                    selectFile: 'Dosya seç',
                    serviceStatus: 'Hizmet durumu',
                    serviceStatusDesc: 'SAML2 etkinleştirilmeden önce mevcut yapılandırma testi geçmelidir.',
                    settingLoadFailed: 'SAML2 ayarları yüklenemedi',
                    settingLoadFailedHelper:
                        'Geçerli ayarların üzerine boş bir varsayılan yapılandırmanın kaydedilmesini önlemek için form kilitlendi. Bağlantı kurtarıldıktan sonra yeniden deneyin.',
                    spCertificate: 'SP sertifikası',
                    spCertificateHelper:
                        'IdP’nin oturum açma ve kapatma isteklerini doğrulayabilmesi için SP meta verilerinde yayımlanır.',
        ...
        node: {
            ...
            dashboardSetting: 'Genel Bakış Ayarları',
            keepOneDashboardComponent: 'En az bir genel bakış bölümü bırakın',
        },
        customApp: {
        ...
        alert: {
            ...
            cronjob: 'Zamanlanmış görev yürütmesi {0} başarısız oldu',
        ...
        vm: {
            ...
            disk: 'Disk',
            overview: 'Genel bakış',
            kvmUnavailable: 'Kullanılabilir KVM donanım sanallaştırma yeteneği algılanmadı.',
            kvmCheckCpu: 'Ana makine CPU’sunun Intel VT-x veya AMD-V sanallaştırmasını desteklediğini doğrulayın.',
            kvmCheckBios: 'BIOS/UEFI içindeki sanallaştırma seçeneklerini etkinleştirin.',
            kvmCheckModule: 'kvm, kvm_intel veya kvm_amd çekirdek modülünün doğru yüklendiğini doğrulayın.',
            kvmCheckDevice:
                '/dev/kvm dosyasının bulunduğunu ve mevcut ortamın KVM desteği olmayan bir konteyner ya da bulut ana makinesi olmadığını doğrulayın.',
            abnormal: 'Anormal',
            resourceOverview: 'Kaynak genel bakışı',
            cpuAllocated: 'Ayrılan CPU',
            memoryAllocated: 'Ayrılan bellek',
            storageUsed: 'Kullanılan depolama',
            riskReminder: 'Risk uyarıları',
            noRisk: 'Risk yok',
            runtimeHealth: 'Çalışma zamanı sağlığı',
            runtimeAbnormal: 'VM çalışma zamanı anormal',
            noDependency: 'Bağımlılık denetimi verisi yok',
            storageOverview: 'Depolama genel bakışı',
            totalAllocated: 'Toplam VM yapılandırmasına göre hesaplanır',
            runningAllocated: 'Çalışanlara ayrılan: {0}',
            storageAvailable: 'Kullanılabilir: {0}',
            inProgress: 'Devam ediyor',
            needAttention: 'İlgilenilmesi gerekiyor',
            normal: 'Normal',
            environmentRisk: 'VM çalışma zamanı hazır değil. Bağımlılıkları veya sanallaştırma hizmetlerini düzeltin.',
            storageRisk: '{0} depolama havuzunun kullanımı %{1} düzeyine ulaştı.',
            abnormalRisk: '{0} VM anormal durumda.',
            pausedRisk: '{0} VM duraklatıldı.',
            memoryRisk: 'VM bellek ayırma oranı %{0} düzeyine ulaştı.',
            ...
            convertToTemplate: 'Şablona dönüştür',
            sourceVM: 'Kaynak VM',
            templateSize: 'Şablon boyutu',
            ...
            monitorLoadFailedWithReason: 'VM izleme verileri alınamadı: {0}',
            rename: 'Yeniden adlandır',
            newName: 'Yeni ad',
            renameHelper: 'Yeni bir VM adı girin. Yeniden adlandırmadan önce VM kapatılmalıdır.',
            renameConfirm: '[{0}] sanal makinesini [{1}] olarak yeniden adlandırmak istiyor musunuz?',
            renameRunningHelper: 'Yeniden adlandırmadan önce sanal makineyi kapatın.',
            cpuUsage: 'CPU kullanımı',
            memoryUsage: 'Bellek kullanımı',
            diskIO: 'Disk G/Ç',
            networkIO: 'Ağ G/Ç',
            diskReadWrite: 'Disk okuma / yazma',
            networkRxTx: 'Ağ RX / TX',
            rx: 'RX',
            tx: 'TX',
            console: 'Konsol',
            ...
            recoverSnapshot: 'Anlık görüntüyü geri yükle',
            snapshotSize: 'Kullanım',
            currentSnapshot: 'Geçerli',
            snapshotEmpty: 'Anlık görüntü yok',
            snapshotHelper:
                'Anlık görüntü, geçerli VM durumunu geri yükleme noktası olarak kaydeder. Sonraki veri değişiklikleri özgün diski değiştirmeden bir fark dosyasına kaydedilir. Anlık görüntünün geri yüklenmesi VM’yi bu duruma döndürür.',
            snapshotOperationHelper:
                'Geçerli anlık görüntü silinemez. Anlık görüntüler yalnızca sanal makine kapalıyken geri yüklenebilir.',
            snapshotRecoverConfirm:
                '[{1}] sanal makinesini [{0}] anlık görüntüsüne geri yüklemek istiyor musunuz? VM diski anlık görüntü durumuna döndürülecektir.',
        ...
        cluster: {
            cluster: 'Uygulama yüksek kullanılabilirliği',
            name: 'Küme adı',
            addCluster: 'Küme ekle',
            installNode: 'Düğüm kur',
            master: 'Ana düğüm',
            slave: 'İkincil düğüm',
